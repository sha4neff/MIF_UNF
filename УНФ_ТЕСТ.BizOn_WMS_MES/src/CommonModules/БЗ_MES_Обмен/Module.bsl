...
Процедура Экспорт_ТоварыВПроизводстве(УзелОбъект)
	...
	Запрос.Текст="ВЫБРАТЬ
	             ...
	             |	И ОстаткиПроизводства.Номенклатура.Изготовитель <> &Изготовитель 
				 |	И ОстаткиПроизводства.Номенклатура.Изготовитель <> &Изготовитель1
	             |
	             |СГРУППИРОВАТЬ ПО
	...
	запрос.УстановитьПараметр("Изготовитель", Справочники.СтруктурныеЕдиницы.НайтиПоКоду("НФ-000016"));       
	запрос.УстановитьПараметр("Изготовитель1", Справочники.СтруктурныеЕдиницы.НайтиПоКоду("НФ-000006"));
