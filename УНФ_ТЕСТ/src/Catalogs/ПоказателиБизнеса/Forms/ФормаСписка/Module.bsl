...
Процедура ЗагрузитьСтандартныйНаборПоказателей(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ЗагрузаСтандартныхПоказателейПродолжение", ЭтотОбъект);
...
&НаКлиенте
Процедура ЗагрузаСтандартныхПоказателейПродолжение(Выбор, ДополнительныеПараметры) Экспорт
