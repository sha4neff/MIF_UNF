...
Функция ТекстЗапросаСОтборамиПоПолямВводПоСтроке(ТекстЗапроса, ОбъектМетаданных)
	...
	Если ОбъектМетаданных.ПолноеИмя() = "Справочник.Контрагенты" Тогда
		ДобавленныеКомпоненты.Добавить(ТекстЗапросаКонтактыПоНомеруТелефона());
		ДобавленныеКомпоненты.Добавить(ТекстЗапросаКонтактыПоАдресуЭП());
	КонецЕсли;
...
Функция ТекстЗапросаКонтактыПоАдресуЭП()
...
Функция ТекстЗапросаКонтактыПоНомеруТелефона()
