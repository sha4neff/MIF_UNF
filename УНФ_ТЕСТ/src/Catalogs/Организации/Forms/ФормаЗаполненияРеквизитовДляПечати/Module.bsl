...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УправлениеКонтактнойИнформацией.ПриСозданииНаСервере(ЭтаФорма, Объект, Новый Структура("ИмяЭлементаДляРазмещения", "ГруппаКонтактнаяИнформация"));
...
Процедура ДобавитьПоляЮрАдрес()
	...
	Если ДанныеЗаполнения.Вид.ВидРедактирования = "Диалог" Тогда
