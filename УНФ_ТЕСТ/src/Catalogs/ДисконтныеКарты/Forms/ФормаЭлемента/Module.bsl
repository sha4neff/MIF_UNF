...
Процедура УправлениеФормой(Форма)
	...
	Если ЗначениеЗаполнено(Объект.Владелец) Тогда
		Элементы.ИнформацияПроцентСкидкиПоДисконтнойКарте.Видимость = УправлениеНебольшойФирмойСервер.ЗначениеРеквизитаОбъекта(Объект.Владелец, "СтарыйМеханизмСкидок");
	Иначе
