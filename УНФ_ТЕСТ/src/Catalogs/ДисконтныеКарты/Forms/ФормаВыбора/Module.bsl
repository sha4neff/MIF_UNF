...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Параметры.Контрагент) Тогда
		Заголовок = "Дисконтные карты. " + СокрЛП(Параметры.Контрагент.Наименование);
	Иначе
		Заголовок = "Дисконтные карты. <Контрагент не выбран>";
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "РасшифрокаСпискаПроцентСкидкиИВладелец", "Видимость", Ложь);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "РасшифрокаСпискаТелефонЭлПочта", "Видимость", Ложь);
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДекорацияРазвернутьОтборы", "Видимость", Ложь);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СписокКонтекстноеМенюПоказатьДополнительнуюИнформацию", "Видимость", Истина);
