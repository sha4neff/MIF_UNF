...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЕстьПравоДобавленияНового Тогда
		...
		УправлениеНебольшойФирмойСервер.ВыделитьЖирнымОсновнойЭлемент(УправлениеНебольшойФирмойПовтИсп.ПолучитьЗначениеНастройки("РабочийПрайсЛистКонтрагентов"), Список);
...
Процедура ИзменитьРабочийПрайсЛистКонтрагентов(РабочийПрайсЛистКонтрагентов)
	...
	Если РабочийПрайсЛистКонтрагентов = УправлениеНебольшойФирмойПовтИсп.ПолучитьЗначениеНастройки("РабочийПрайсЛистКонтрагентов") Тогда
		
		Возврат;
		
	КонецЕсли;
	
	УправлениеНебольшойФирмойСервер.УстановитьНастройкуПользователя(РабочийПрайсЛистКонтрагентов, "РабочийПрайсЛистКонтрагентов");
	УправлениеНебольшойФирмойСервер.ВыделитьЖирнымОсновнойЭлемент(РабочийПрайсЛистКонтрагентов, Список);
