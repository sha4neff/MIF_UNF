...
Функция НовыйМаксимальныйРеквизитДопУпорядочивания(СтарыйРеквизитДопУпорядочивания)
	...
	Запрос.Текст =
	"ВЫБРАТЬ ПЕРВЫЕ 1
	|	СостоянияЗаказовПоставщикам.РеквизитДопУпорядочивания КАК РеквизитДопУпорядочивания
	|ИЗ
	|	Справочник.СостоянияЗаказовПоставщикам КАК СостоянияЗаказовПоставщикам
	|ГДЕ
	|	СостоянияЗаказовПоставщикам.Ссылка <> ЗНАЧЕНИЕ(Справочник.СостоянияЗаказовПоставщикам.Завершен)
	|	И СостоянияЗаказовПоставщикам.Ссылка <> &СтарыйРеквизитДопУпорядочивания
	|	И СостоянияЗаказовПоставщикам.РеквизитДопУпорядочивания < (ВЫРАЗИТЬ(99998 КАК ЧИСЛО(5, 0)))
	|
	|УПОРЯДОЧИТЬ ПО
