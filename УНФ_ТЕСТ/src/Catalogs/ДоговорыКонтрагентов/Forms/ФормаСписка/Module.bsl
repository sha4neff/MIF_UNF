...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(КонтрагентВладелец) Тогда
		...
		Если Интеркампани И ЭтоПоступлениеДенег Тогда
			...
			УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(Список, "ДоговорИнтеркампани", Истина);
		ИначеЕсли Интеркампани Тогда
			УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(Список, "Владелец", Организация);
			УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(Список, "ДоговорИнтеркампани", Истина);
		// Конец Интеркампани
		Иначе
	...
	Если Параметры.Свойство("ЭтоДоговорЭквайринга") Тогда
		УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(Список, "ЭтоДоговорЭквайринга", Параметры.ЭтоДоговорЭквайринга);
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(КонтрагентВладелец) Тогда
		...
		Если ТипЗнч(КонтрагентВладелец) = Тип("СправочникСсылка.Контрагенты") Тогда
		...
		// Интеркампани
		Если ТипЗнч(КонтрагентВладелец) = Тип("СправочникСсылка.Организации") Тогда
