...
Процедура ОпределитьПраваРаботыСНоменклатурой()
	...
	РазрешеноПодключениеПодсистемыРаботаСНоменклатурой = РольДоступна("ПолныеПрава");
	Если ИспользоватьСервисРаботаСНоменклатурой Тогда
		РазрешенаРаботаСПодсистемойРаботаСНоменклатурой = РольДоступна("ПолныеПрава") ИЛИ РольДоступна("ДобавлениеИзменениеДанныхРаботаСНоменклатурой");
	КонецЕсли;
