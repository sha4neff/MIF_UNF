...
Процедура ВыполнитьДействияПоИсточнику(Действия, Источник, Правило, Автор, ДопДанныеИсточника) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		//{kp-unf.ru
		Если МетаданныеИсточника.Имя="КП_Задача" Тогда
			Если ЗначениеНастройки="Наименование" Тогда
				РеквизитыОснования.Добавить(ЗначениеНастройки);
			ИначеЕсли МетаданныеИсточника.РеквизитыАдресации.Найти(ЗначениеНастройки) <> Неопределено Тогда
				РеквизитыОснования.Добавить(ЗначениеНастройки);
			КонецЕсли;
		КонецЕсли;
		//kp-unf.ru}
