...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЭтоИзменениеИнтервалаГрафика Тогда
		...
		ЭтаФорма.Заголовок = "Расписание на дату: " + Формат(ДатаДня,"ДЛФ=Д");
...
&НаКлиенте
Процедура РасчитатьВремяПерерывовИСформироватьПредставлениеРасписанияПриОткрытии(ЭтоВремяНачалаПерерыва = Истина, ОткрытиеФормы = Ложь)
