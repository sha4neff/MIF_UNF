...
// Объединяет массив табличных документов в один табличный документ
// 
// Параметры:
// 	ПечатаемыеОбъекты - Массив
...
// Добавляет табличный документ в коллекцию печатаемых объектов
// 
// Параметры:
// 	КоллекцияПечатаемыхОбъектов - Массив - .
// 	ТабличныйДокумент - ТабличныйДокумент, Неопределено - .
// 	ОписаниеПечатаемогоОбъекта - Строка, Неопределено - .
Процедура ДобавитьТабличныйДокументВКоллекциюПечатаемыхОбъектов(КоллекцияПечатаемыхОбъектов, ТабличныйДокумент,
	ОписаниеПечатаемогоОбъекта = Неопределено) Экспорт
	ПечатаемыйОбъект = РегламентированнаяОтчетностьПереопределяемый.ПустаяСтруктураДляРазделовФормыРСВ_1();
...
Функция ПечатныеФормыКомплекта2014Года(Ссылка, ПараметрыФормированияПечатныхФорм, НумероватьСтраницы = Истина, НомерПервойстраницыРаздела25 = 0, НомерПоследнейстраницыРаздела25 = 1, НомерПервойстраницыРаздела6 = 0, ОбщееКоличествоСтраницРаздела6 = 0) Экспорт
	...
	Если ПараметрыФормированияПечатныхФорм.ФормироватьПечатныеФормыРаздел6 Тогда
		...
		ПечатныеФормыСЗВ62 = Документы.РеестрСЗВ_6_2.ТабличныеДокументыФормСЗВ_6_2(ПечатаемыеДокументы);
		...
		ПечатныеФормыСЗВ64 = Документы.ПачкаДокументовСЗВ_6_4.ТабличныеДокументыФормыСЗВ_6_4(ПечатаемыеДокументы, , Истина);
		...
		ПечатныеФормыРаздела6 = Документы.ПачкаРазделов6РасчетаРСВ_1.ТабличныеДокументыРаздела6РСВ_1(ПечатаемыеДокументы, ДокументыКомплекта, ,НумероватьСтраницы, НомерПервойСтраницы, НомерПоследнейСтраницыРаздела6);
...
Функция НовыйЛистРаздела25(НумероватьСтраницы, ТекущийНомерСтраницы, НомерПервойСтраницы, ОбластьВерхнийКолонтитул)
	...
	ПерсонифицированныйУчет.ПроставитьНомерСтраницыВЯчейках(НумероватьСтраницы, ТекущийНомерСтраницы,
		ОбластьВерхнийКолонтитул);
	ДокументРезультат.Вывести(ОбластьВерхнийКолонтитул);
...
Функция ТекстОписанияДокументаРаздела6(ОписаниеПечатаемогоОбъекта)
	...
	Если ОписаниеПечатаемогоОбъекта <> Неопределено Тогда 
		Если ТипЗнч(ОписаниеПечатаемогоОбъекта.Ссылка) = Тип("ДокументСсылка.РеестрСЗВ_6_2") Тогда
