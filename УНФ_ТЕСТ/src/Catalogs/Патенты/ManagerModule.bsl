...
// Возвращает действующий патент организации, если он у нее один.
//
// Параметры:
//  пОрганизация  - СправочникСсылка.Организации - организация,
//                 чей патент нужно получить.
//  пДата  - Дата - дата, на которую нужно получить патент.
//                  Если передана пустая дата, то патент будет получен
//                  на текущую дату сеанса.
//
// Возвращаемое значение:
//   СправочникСсылка.Патенты, Неопределено   - если у организации один действующий патент
//                                              на дату, которая передана в параметр пДата,
//                                              то функция вернет этот патент. В ином случае - Неопределено.
//
Функция ПолучитьПатентПоУмолчанию(пОрганизация, пДата = '00010101') Экспорт
	
	МассивПатентов = ПолучитьПатентыОрганизации(
		пОрганизация,
		?(пДата = '00010101', ТекущаяДатаСеанса(), пДата));
	
	Если МассивПатентов.Количество() = 1 Тогда
		Возврат МассивПатентов[0];
	Иначе
