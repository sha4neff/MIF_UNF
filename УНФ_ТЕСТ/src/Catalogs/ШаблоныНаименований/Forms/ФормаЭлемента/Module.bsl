...
Процедура СоздатьКомандыДобавленияСвойств()
	...
	ШаблоныНаименованийСписокСвойств.Добавить("Артикул", "Артикул");
	...
	Если Объект.ВидНаименования = Перечисления.ВидыНаименованийОбъектов.ДоговорКонтрагента Тогда
		...
		НоваяСтрока.Представление = "Вид договора";
		НоваяСтрока.Заголовок     = "";
		
		ШаблоныНаименованийСписокСвойств.Добавить("Код", "ФР-01");
		ШаблоныНаименованийСписокСвойств.Добавить("НомерДоговора", "НФ-0002");
		...
		ШаблоныНаименованийСписокСвойств.Добавить("Владелец", """Наша фирма""");
		ШаблоныНаименованийСписокСвойств.Добавить("ВалютаРасчетов", "RUB");
		ШаблоныНаименованийСписокСвойств.Добавить("ВидДоговора", "с поставщиком");
