...
Процедура ДобавитьВыбранныйСертификат(Результат, ДополнительныеПараметры) Экспорт
	...
	СтруктураРеквизитовСертификата = УправлениеНебольшойФирмойСервер.ЗначенияРеквизитовОбъекта(ПодарочныйСертификат, "ИспользоватьСерийныеНомера, Номинал");
...
Процедура УправлениеДоступностьюИВидимостью()
	...
	Элементы.НомерСертификата.Доступность = ПодарочныйСертификат.ИспользоватьСерийныеНомера;
	
	Элементы.Сумма.СписокВыбора.Очистить();
	Если ЗначениеЗаполнено(КОплате) Тогда
		Элементы.Сумма.СписокВыбора.Добавить(КОплате, ""+КОплате+" (к оплате)");
	КонецЕсли;
	Если ПодарочныйСертификат.ИспользоватьСерийныеНомера Тогда
		Если ЗначениеЗаполнено(Остаток) Тогда
			Элементы.Сумма.СписокВыбора.Добавить(Остаток, ""+Остаток+" (остаток)");
		КонецЕсли;
	Иначе
		Элементы.Сумма.СписокВыбора.Добавить(ПодарочныйСертификат.Номинал, ""+ПодарочныйСертификат.Номинал+" (номинал)");
	КонецЕсли;
...
Процедура ОбновитьДанныеСертификата()
	...
	СтруктураРеквизитовСертификата = УправлениеНебольшойФирмойСервер.ЗначенияРеквизитовОбъекта(ПодарочныйСертификат, "ИспользоватьСерийныеНомера, Номинал, ЧастичноеПогашение");
	ЗаполнитьЗначенияСвойств(ЭтаФорма, СтруктураРеквизитовСертификата);
