...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ТипПоля.СписокВыбора.Добавить(Перечисления.ТипыПолейКонструктораФорм.ОдинИзСписка, "Один из списка");
	Элементы.ТипПоля.СписокВыбора.Добавить(Перечисления.ТипыПолейКонструктораФорм.НесколькоИзСписка, "Несколько из списка");
	Элементы.ТипПоля.СписокВыбора.Добавить(Перечисления.ТипыПолейКонструктораФорм.РаскрывающийсяСписок, "Раскрывающийся список");
