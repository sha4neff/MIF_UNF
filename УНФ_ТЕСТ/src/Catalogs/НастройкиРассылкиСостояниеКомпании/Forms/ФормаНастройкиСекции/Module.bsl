...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПравоДоступа("Изменение", Метаданные.Справочники.НастройкиРассылкиСостояниеКомпании) Тогда
...
Процедура Сохранить(Команда)
	...
	Если Не ЗначениеЗаполнено(ЗаголовокСекции) Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Укажите заголовок секции.'"),,, "ЗаголовокСекции");
		Возврат;
	КонецЕсли;
	
	Если Не ЗначениеЗаполнено(ТипСекции) Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru = 'Укажите тип секции.'"),,, "ТипСекции");
		Возврат;
	КонецЕсли;
