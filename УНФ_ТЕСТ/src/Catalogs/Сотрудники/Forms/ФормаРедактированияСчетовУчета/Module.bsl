...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОтказИзменитьСчетРасчетовСПерсоналом(Ссылка) Тогда
		Элементы.ПояснениеСПерсоналом.Заголовок = НСтр("ru = 'В базе есть движения по этому сотруднику! Изменение счетов учета по расчетам с персоналом запрещено!'");
	...
	Если ОтказИзменитьСчетРасчетовСПодотчетниками(Ссылка) Тогда
		Элементы.ПояснениеСПодотчетником.Заголовок = НСтр("ru = 'В базе есть движения по этому подотчетнику! Изменение счетов учета по расчетам с подотчетниками запрещено!'");
