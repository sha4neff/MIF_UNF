...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Включение опции автоматических скидок при созданни нового вида ДК
	Если Не ЗначениеЗаполнено(Объект.Ссылка) Тогда
		ДисконтныеКартыСервер.ПроверитьИУстановитьОпциюАвтоматическиеСкидки();
...
Процедура УправлениеВидимостьюНаСервере()
	...
	Если Не Объект.СтарыйМеханизмСкидок Тогда
		ЕстьДействующиеСкидки = ДисконтныеКартыСервер.ЕстьСкидкиПоВидуКарт(Объект.Ссылка);
