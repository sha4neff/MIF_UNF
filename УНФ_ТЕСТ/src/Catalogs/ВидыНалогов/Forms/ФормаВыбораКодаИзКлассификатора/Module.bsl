...
Процедура ОпределитьНомерПриказа()
	...
	Если ГодНачалаДействияПриказа = "2020" Тогда
		ИмяМакета      = "КлассификацияДоходовБюджетов";
		НадписьПриказа = НСтр("ru = 'по приказу Минфина от 06.06.2019 г. № 85н
			|(в редакции приказа Минфина от 17.09.2019 г. № 148н)'");
	Иначе
		ИмяМакета      = "КлассификацияДоходовБюджетов2019";
		НадписьПриказа = НСтр("ru = 'по приказу Минфина от 08.06.2018 г. № 132н
			|(в редакции приказа Минфина от 25.11.2019 г. № 197н)'");
	КонецЕсли;
...
Процедура НастроитьСписокВыбора()
	...
	СписокВыбора.Добавить(Формат(Год(ДатаАктуальностиКлассификатора), "ЧГ=0"), Формат(ДатаАктуальностиКлассификатора,
		"ДФ='yyyy ""г.""'"));
