...
Процедура ИнформацияОМинимальнойЦене()
	...
	Если Элементы.ОбновитьИнформациюОМинимальнойЦене.Видимость Тогда
		...
		Если Выборка.Следующий() Тогда
			...
			Тело = НСтр("ru ='Минимальная цена <b>%1</b> зарегистрирована <b>%2</b> и состовляет <b>%3</b> руб. %4'");
			...
			Элементы.ОбновитьИнформациюОМинимальнойЦенеРасширеннаяПодсказка.Заголовок = СтроковыеФункцииКлиентСервер.ФорматированнаяСтрока(СтрокаЗаголовка);
