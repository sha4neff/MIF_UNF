...
Функция ОпределитьСистемуНалогообложенияОрганизации(Организация, Знач Дата) экспорт
	...
	Если Не ЗначениеЗаполнено(Организация) Тогда
		Возврат Новый Структура("СистемаНалогообложения, ПлательщикУСН, ПлательщикЕНВД, ПрименяетсяПатент",Перечисления.СистемыНалогообложения.Общая, Ложь, Ложь, Ложь);;
	КонецЕсли;
