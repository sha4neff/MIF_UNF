...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаОтладки.Видимость = ИнтеграцияОбменШтрихМКлиентСервер.РежимОтладкиОбменаШтрихМ();
...
Процедура УстановитьСостояниеОбъекта()
	...
	Если СостояниеРегистрации = Перечисления.СостоянияРегистрацииКассовогоАппарата.НеПодключен
		...
		ИначеЕсли ИнформацияПоТарифам.СвободноЛицензий = 0 Тогда
			Элементы.СтраницыПодключения.ТекущаяСтраница = Элементы.СтраницаНетЛицензий;
			Элементы.ДекорацияНетЛицензий.Заголовок = 
				НСтр("ru = 'Для вашего тарифного плана подключено максимальное количество касс."
					"Если вы только что отключили кассу от сервиса, подождите, информация об отключении обновится через некоторое время."
					"По вопросам вашего тарифного плана обратитесь к обслуживающему вас партнеру компании 1С.'");
		Иначе
