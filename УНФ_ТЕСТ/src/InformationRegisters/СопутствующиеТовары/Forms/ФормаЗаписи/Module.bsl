...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ХарактеристикаCопутствующегоТовара.Видимость = Запись.СопутствующийТовар.ИспользоватьХарактеристики;
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	Если Запись.Номенклатура = Запись.СопутствующийТовар
		И Запись.Характеристика = Запись.ХарактеристикаCопутствующегоТовара Тогда
...
Процедура СопутствующийТоварПриИзмененииНаСервере()
	Элементы.ХарактеристикаCопутствующегоТовара.Видимость = Запись.СопутствующийТовар.ИспользоватьХарактеристики;
	Запись.ХарактеристикаCопутствующегоТовара = Справочники.ХарактеристикиНоменклатуры.ПустаяСсылка()
КонецПроцедуры
