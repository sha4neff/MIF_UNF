...
// См. НастройкиИнтеграцииCRM.ВыполнитьКоманду
...
Функция УчетныеСистемыДляСинхронизацииОбъекта(ОбъектСсылка)
	...
	МетеданныеОбъекта = ОбъектСсылка.Метаданные();
	...
	Если ДвусторонняяСинхронизацияОбъектов.Найти(МетеданныеОбъекта) <> Неопределено Тогда
	...
	Если ОдносторонняяСинхронизацияОбъектов.Найти(МетеданныеОбъекта) = Неопределено Тогда
