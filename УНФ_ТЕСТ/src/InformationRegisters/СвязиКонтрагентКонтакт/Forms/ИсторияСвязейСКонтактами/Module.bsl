...
Процедура СписокПриАктивизацииСтроки(Элемент)
	...
	Если ТипЗнч(Элемент.ТекущиеДанные) = ТипЗнч(Неопределено) 
		...
		УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(СвязьКонтактКонтрагент, 
			"Контакт", 
			МассивОтбора, 
			Истина, 
		...
		УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(СвязьКонтактКонтрагент, "Контрагент", МассивОтбораКонтрагент, Истина, ВидСравненияКомпоновкиДанных.ВСписке);
		Возврат;
...
Функция ИзменитьПорядокЗаписей(Контрагент, Контакт, Смещение, ВключатьНедействительные)
	...
	РегистрыСведений.СвязиКонтрагентКонтакт.ИзменитьПорядок(Контрагент, Контакт, Смещение, ПорядокИзменен, ВключатьНедействительные);
...
Процедура УстановитьОтборыСвязей(Контакт)
	...
	УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(СвязьКонтактКонтрагент, "Контакт", МассивОтбора, Истина, ВидСравненияКомпоновкиДанных.ВСписке);
