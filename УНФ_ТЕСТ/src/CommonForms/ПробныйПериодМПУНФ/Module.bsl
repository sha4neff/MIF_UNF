...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ДекорацияВоВремяПробногоПериода.Заголовок = СтрЗаменить(Элементы.ДекорацияВоВремяПробногоПериода.Заголовок, "%КоличествоОставшихсяДней%", Строка(КоличествоОставшихсяДней));
	Элементы.ДекорацияВоВремяПробногоПериода.Заголовок = СтрЗаменить(Элементы.ДекорацияВоВремяПробногоПериода.Заголовок, "%Дней%", ТекстДней);
