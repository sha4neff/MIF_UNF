...
Процедура ПрепятствующиеУдалениюВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ПоказатьЗначение(Новый ОписаниеОповещения("ПрепятствующиеУдалениюВыборЗавершение", ЭтотОбъект), ВыбранныйОбъект);
	
КонецПроцедуры

&НаКлиенте
Процедура ПрепятствующиеУдалениюВыборЗавершение(ДополнительныеПараметры) Экспорт
