...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если УправлениеНебольшойФирмойКлиентСервер.ЭтоiOS() Тогда
...
Процедура БольшеНеСпрашивать(Команда)
	...
	УправлениеНебольшойФирмойВызовСервера.УстановитьЗапретОткрытияФормыОпроса(Истина);
	Закрыть();
...
Процедура Завершить(Команда)
	...
	УправлениеНебольшойФирмойСервер.ОтправитьСобытиеСДопДанными(НСтр("ru='Опрос по мобильному клиенту'"), ОпросДляОтправки, СообщениеОбОшибке);
