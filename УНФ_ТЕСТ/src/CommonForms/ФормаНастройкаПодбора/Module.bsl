...
Процедура ЗаписатьНастройкиОтчета()
	...
	УправлениеНебольшойФирмойСервер.УстановитьНастройкуПользователя(ПоказыватьСвободныйОстаток,
	...
	УправлениеНебольшойФирмойСервер.УстановитьНастройкуПользователя(ЗапоминатьТекущуюИерархию,
		"ЗапоминатьТекущуюИерархию");
