...
Процедура ПерейтиВКонструкторНажатие(Элемент)
	Попытка
		ОткрытьФорму("Справочник.НастройкиПубликацииМЛК.Форма.КонструкторМобильногоПриложения");
	Исключение
...
// Установливает URL для каждого приложения
//
&НаСервере
...
Процедура УстановитьВидимостьЭлементов()
	...
	ПредопределеннаяВидимостьПриложений.Вставить("Группа_ЗАК", 		Ложь);
	ПредопределеннаяВидимостьПриложений.Вставить("Группа_МКс", 		Истина);
	ПредопределеннаяВидимостьПриложений.Вставить("Группа_КЛД",		Ложь);
	ПредопределеннаяВидимостьПриложений.Вставить("Группа_ПЦ", 		Ложь);
