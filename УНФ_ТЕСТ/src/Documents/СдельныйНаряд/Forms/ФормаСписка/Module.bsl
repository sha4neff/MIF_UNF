...
Функция СформироватьСдельныеНарядыИЗаписать(МассивЗаказов)
	...
	Для каждого СтрокаЗнП Из МассивЗаказов Цикл
		...
		НовыйДокументСН = Документы.СдельныйНаряд.СоздатьДокумент();
		НовыйДокументСН.Дата = ТекущаяДата();
		НовыйДокументСН.Заполнить(СтрокаЗнП);
		НовыйДокументСН.Записать();
		МассивСН.Добавить(НовыйДокументСН.Ссылка);
