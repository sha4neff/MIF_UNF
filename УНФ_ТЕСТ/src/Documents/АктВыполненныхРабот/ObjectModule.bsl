...
Процедура ЗаполнитьПоЗаказуПокупателя(ДокументСсылкаЗаказПокупателя) Экспорт
	...
	Пока ВыборкаНаподходящиеНаборы.Следующий() Цикл
		ДобавитьОписаниеНабора(ПропускаемыеНаборы, ВыборкаНаподходящиеНаборы.ЗаказПокупателя, ВыборкаНаподходящиеНаборы.НоменклатураНабора, ВыборкаНаподходящиеНаборы.ХарактеристикаНабора);	
	КонецЦикла; 
	// Конец Наборы
...
Процедура ЗаполнитьПоЗаказуНаПроизводство(ДокументСсылкаЗаказНаПроизводство) Экспорт
	...
	Если ЗначениеЗаполнено(ВидЦен) Тогда
		...
		УправлениеНебольшойФирмойСервер.ПолучитьЦеныТабличнойЧастиПоВидуЦен(СтруктураДанных, РаботыИУслуги);
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для каждого Строка Из ТаблицаПредоплата Цикл
		...
		Если НайденнаяСтрокаРаботыИУслуги = Неопределено
		   ...
		   И Контрагент.ВестиРасчетыПоЗаказам
