...
Процедура ОбновитьРеквизитыВидимостиФормы()
	...
	СтрокаРеквизитов = "ГарантийныйСрок,ИспользоватьСерийныеНомера,ВыписыватьГарантийныйТалон,ИспользоватьХарактеристики,ПроверятьЗаполнениеХарактеристики";
...
Процедура ОбновитьСрокДействияГарантии()
	...
	ЗначРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Объект.Номенклатура, "ИспользоватьСерийныеНомера,ГарантийныйСрок");
	ИспользоватьСерийныеНомера = ЗначРеквизитов.ИспользоватьСерийныеНомера;
	ГарантийныйСрок = ЗначРеквизитов.ГарантийныйСрок;
	
	Если ИспользоватьСерийныеНомера И ЗначениеЗаполнено(Объект.СерийныйНомер) Тогда
...
Процедура ОбновитьДокументПродажи()
	...
	// Документ продажи
	Если ЗначениеЗаполнено(Объект.Номенклатура) И (ЗначениеЗаполнено(Объект.СерийныйНомер) ИЛИ НЕ ИспользоватьСерийныеНомера) Тогда
...
&НаСервере
Процедура ПолучитьСерийныеНомераИзХранилища(АдресВоВременномХранилище, КлючСтроки)
...
Функция ПараметрыПодбораСерийныхНомеровВПолеВвода()
	...
	Возврат РаботаСФормойДокумента.ПараметрыПодбораСерийныхНомеровДляРемонтов(Объект,
