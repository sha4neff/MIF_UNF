...
Функция ДанныеПолученныхДокументовРегУчет(МассивОбъектов, ИспользоватьФаксимиле, ПечатнаяФормаТолькоВРублях = Истина,
	...
	|	,Выбор КОГДА ДополнительныеРасходы.Контрагент.ГоловнойКонтрагент <> Значение(Справочник.Контрагенты.ПустаяСсылка)
	|		ТОГДА ДополнительныеРасходы.Контрагент.ГоловнойКонтрагент
	|		ИНАЧЕ ДополнительныеРасходы.Контрагент КОНЕЦ КАК Организация
	...
	|	,Выбор КОГДА ДополнительныеРасходы.Контрагент.ВидКонтрагента = Значение(Перечисление.ВидыКонтрагентов.ФизическоеЛицо)
	|		ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ КОНЕЦ КАК ЭтоФизическоеЛицо
	|	,Выбор КОГДА ДополнительныеРасходы.НалогообложениеНДС = Значение(Перечисление.ТипыНалогообложенияНДС.НеОблагаетсяНДС)
	|		ТОГДА 2
	...
	|	,Выбор КОГДА ДополнительныеРасходы.Организация.ГоловнаяОрганизация <> Значение(Справочник.Организации.ПустаяСсылка)
	|		ТОГДА ДополнительныеРасходы.Организация.ГоловнаяОрганизация
	|		ИНАЧЕ ДополнительныеРасходы.Организация КОНЕЦ КАК Контрагент
	...
	|		ИНАЧЕ ДополнительныеРасходы.ВалютаДокумента КОНЕЦ КАК ВалютаДокумента
	|	,Выбор КОГДА &ПечатнаяФормаТолькоВРублях = ИСТИНА 
	|		ТОГДА НациональнаяВалюта.Значение.НаименованиеПолное
	|		ИНАЧЕ ДополнительныеРасходы.ВалютаДокумента.НаименованиеПолное КОНЕЦ КАК ВалютаНаименование
	|	,Выбор КОГДА &ПечатнаяФормаТолькоВРублях = ИСТИНА 
	|		ТОГДА НациональнаяВалюта.Значение.Код
	|		ИНАЧЕ ДополнительныеРасходы.ВалютаДокумента.Код КОНЕЦ КАК ВалютаКод
	...
	|		,Выбор КОГДА ВЫРАЗИТЬ(ДополнительныеРасходы.Расходы.Номенклатура.НаименованиеПолное КАК СТРОКА(1000)) = """"
	|			ТОГДА ДополнительныеРасходы.Расходы.Номенклатура.Наименование
	|			ИНАЧЕ ВЫРАЗИТЬ(ДополнительныеРасходы.Расходы.Номенклатура.НаименованиеПолное КАК СТРОКА(1000)) КОНЕЦ КАК ПредставлениеНоменклатуры
	...
	|		,Выбор КОГДА ДополнительныеРасходы.Расходы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	...
	|				ИНАЧЕ ДополнительныеРасходы.Расходы.Номенклатура.ЕдиницаИзмерения.Наименование КОНЕЦ КАК ЕдиницаИзмеренияПоОКЕИ_Наименование
	|		,Выбор КОГДА ДополнительныеРасходы.Расходы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	|			И ПечатьПользовательскихЕдиницИзмерения.Значение = ЗНАЧЕНИЕ(Перечисление.ПечатьПользовательскихЕдиницИзмерения.ФормироватьПечатныйДокументВПользовательскойЕдинице)
	|			И ДополнительныеРасходы.Расходы.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору <> ЗНАЧЕНИЕ(Справочник.КлассификаторЕдиницИзмерения.ПустаяСсылка)
	|				ТОГДА ДополнительныеРасходы.Расходы.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору.Код
	|				ИНАЧЕ ДополнительныеРасходы.Расходы.Номенклатура.ЕдиницаИзмерения.Код КОНЕЦ КАК ЕдиницаИзмеренияПоОКЕИ_Код
	|		,Выбор КОГДА ДополнительныеРасходы.Расходы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	|			И ПечатьПользовательскихЕдиницИзмерения.Значение = ЗНАЧЕНИЕ(Перечисление.ПечатьПользовательскихЕдиницИзмерения.ФормироватьПечатныйДокументВПользовательскойЕдинице)
	|			И ДополнительныеРасходы.Расходы.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору <> ЗНАЧЕНИЕ(Справочник.КлассификаторЕдиницИзмерения.ПустаяСсылка)
	|				ТОГДА ДополнительныеРасходы.Расходы.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору
	|				ИНАЧЕ ДополнительныеРасходы.Расходы.Номенклатура.ЕдиницаИзмерения КОНЕЦ КАК ЕдиницаИзмерения
	|		,Выбор КОГДА ДополнительныеРасходы.Расходы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	|			И ПечатьПользовательскихЕдиницИзмерения.Значение <> ЗНАЧЕНИЕ(Перечисление.ПечатьПользовательскихЕдиницИзмерения.ФормироватьПечатныйДокументВПользовательскойЕдинице)
	...
	|			ИНАЧЕ ДополнительныеРасходы.Расходы.Цена КОНЕЦ КАК Цена
	|		,Выбор КОГДА &ПечатнаяФормаТолькоВРублях = ИСТИНА
	|				ИЛИ (Ссылка.Договор.РасчетыВУсловныхЕдиницах = ИСТИНА 
	|						И Ссылка.ВалютаДокумента <> НациональнаяВалюта.Значение)
	...
	|			ИНАЧЕ ДополнительныеРасходы.Расходы.Сумма КОНЕЦ КАК Сумма
	|		,Выбор КОГДА &ПечатнаяФормаТолькоВРублях = ИСТИНА
	|				ИЛИ (Ссылка.Договор.РасчетыВУсловныхЕдиницах = ИСТИНА 
	|						И Ссылка.ВалютаДокумента <> НациональнаяВалюта.Значение)
	...
	|			ИНАЧЕ ДополнительныеРасходы.Расходы.СуммаНДС КОНЕЦ КАК СуммаНДС
	|		,Выбор КОГДА &ПечатнаяФормаТолькоВРублях = ИСТИНА
	|				ИЛИ (Ссылка.Договор.РасчетыВУсловныхЕдиницах = ИСТИНА 
	|						И Ссылка.ВалютаДокумента <> НациональнаяВалюта.Значение)
	...
	|			ИНАЧЕ ДополнительныеРасходы.Расходы.Всего КОНЕЦ КАК Всего
	...
	|
	|ИЗ Документ.ДополнительныеРасходы КАК ДополнительныеРасходы
	...
	|ГДЕ ДополнительныеРасходы.Ссылка В(&МассивОбъектов)
	|УПОРЯДОЧИТЬ ПО ДополнительныеРасходы.Расходы.НомерСтроки";
