...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаРасходыПриИмпорте, СтруктураДополнительныеСвойства) Экспорт
	...
	|	ВЫБОР
	|		КОГДА
	|			РасходыПриИмпортеЗапасы.Ссылка.ПоложениеСклада = ЗНАЧЕНИЕ(Перечисление.ПоложениеРеквизитаНаФорме.ВТабличнойЧасти)
	...
	|			ТОГДА РасходыПриИмпортеЗапасы.СуммаСбора * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс *
	|				КурсыРегВалюты.Кратность)
	|		ИНАЧЕ РасходыПриИмпортеЗапасы.СуммаСбора * РасходыПриИмпортеЗапасы.Ссылка.Курс * КурсыУпрВалюты.Кратность /
	|			(КурсыУпрВалюты.Курс * РасходыПриИмпортеЗапасы.Ссылка.Кратность)
	|	КОНЕЦ КАК ЧИСЛО(15, 2)) КАК СуммаСбора,
	|	ВЫРАЗИТЬ(ВЫБОР
	|		КОГДА РасходыПриИмпортеЗапасы.Ссылка.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|			ТОГДА РасходыПриИмпортеЗапасы.СуммаСбора * КурсыРегВалюты.Курс * РасходыПриИмпортеЗапасы.Ссылка.Кратность /
	|				(РасходыПриИмпортеЗапасы.Ссылка.Курс * КурсыРегВалюты.Кратность)
	|		ИНАЧЕ РасходыПриИмпортеЗапасы.СуммаСбора
	|	КОНЕЦ КАК ЧИСЛО(15, 2)) КАК СуммаСбораВал,
	|	ВЫРАЗИТЬ(ВЫБОР
	|		КОГДА РасходыПриИмпортеЗапасы.Ссылка.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|			ТОГДА РасходыПриИмпортеЗапасы.СуммаПошлины * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс
	|				* КурсыРегВалюты.Кратность)
	|		ИНАЧЕ РасходыПриИмпортеЗапасы.СуммаПошлины * РасходыПриИмпортеЗапасы.Ссылка.Курс * КурсыУпрВалюты.Кратность /
	|			(КурсыУпрВалюты.Курс * РасходыПриИмпортеЗапасы.Ссылка.Кратность)
	|	КОНЕЦ КАК ЧИСЛО(15, 2)) КАК СуммаПошлины,
	|	ВЫРАЗИТЬ(ВЫБОР
	|		КОГДА РасходыПриИмпортеЗапасы.Ссылка.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|			ТОГДА РасходыПриИмпортеЗапасы.СуммаПошлины * КурсыРегВалюты.Курс * РасходыПриИмпортеЗапасы.Ссылка.Кратность /
	|				(РасходыПриИмпортеЗапасы.Ссылка.Курс * КурсыРегВалюты.Кратность)
	|		ИНАЧЕ РасходыПриИмпортеЗапасы.СуммаПошлины
	|	КОНЕЦ КАК ЧИСЛО(15, 2)) КАК СуммаПошлиныВал,
	|	ВЫРАЗИТЬ(ВЫБОР
	|		КОГДА РасходыПриИмпортеЗапасы.Ссылка.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|			ТОГДА РасходыПриИмпортеЗапасы.СуммаНДС * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс *
	|				КурсыРегВалюты.Кратность)
	|		ИНАЧЕ РасходыПриИмпортеЗапасы.СуммаНДС * РасходыПриИмпортеЗапасы.Ссылка.Курс * КурсыУпрВалюты.Кратность /
	|			(КурсыУпрВалюты.Курс * РасходыПриИмпортеЗапасы.Ссылка.Кратность)
	|	КОНЕЦ КАК ЧИСЛО(15, 2)) КАК СуммаНДС,
	|	ВЫРАЗИТЬ(ВЫБОР
	|		КОГДА РасходыПриИмпортеЗапасы.Ссылка.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|			ТОГДА РасходыПриИмпортеЗапасы.СуммаНДС * КурсыРегВалюты.Курс * РасходыПриИмпортеЗапасы.Ссылка.Кратность /
	|				(РасходыПриИмпортеЗапасы.Ссылка.Курс * КурсыРегВалюты.Кратность)
	...
	|			ТОГДА РасходыПриИмпортеРасходы.ТаможенныйШтраф * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность /
	|				(КурсыУпрВалюты.Курс * КурсыРегВалюты.Кратность)
	|		ИНАЧЕ РасходыПриИмпортеРасходы.ТаможенныйШтраф * РасходыПриИмпортеРасходы.Курс * КурсыУпрВалюты.Кратность /
	|			(КурсыУпрВалюты.Курс * РасходыПриИмпортеРасходы.Кратность)
	|	КОНЕЦ КАК ЧИСЛО(15, 2)) КАК СуммаШтраф,
	|	ВЫРАЗИТЬ(ВЫБОР
	|		КОГДА РасходыПриИмпортеРасходы.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|			ТОГДА РасходыПриИмпортеРасходы.ТаможенныйШтраф * КурсыРегВалюты.Курс * РасходыПриИмпортеРасходы.Кратность /
	|				(РасходыПриИмпортеРасходы.Курс * КурсыРегВалюты.Кратность)
	...
	|	ВЫБОР
	|		КОГДА
	|			РасходыПриИмпортеЗапасыНДС.Ссылка.ПоложениеСклада = ЗНАЧЕНИЕ(Перечисление.ПоложениеРеквизитаНаФорме.ВТабличнойЧасти)
	...
	|			ТОГДА РасходыПриИмпортеЗапасыНДС.СуммаНДС * КурсыРегВалюты.Курс * КурсыУпрВалюты.Кратность / (КурсыУпрВалюты.Курс *
	|				КурсыРегВалюты.Кратность)
	|		ИНАЧЕ РасходыПриИмпортеЗапасыНДС.СуммаНДС * РасходыПриИмпортеЗапасыНДС.Ссылка.Курс * КурсыУпрВалюты.Кратность /
	|			(КурсыУпрВалюты.Курс * РасходыПриИмпортеЗапасыНДС.Ссылка.Кратность)
	|	КОНЕЦ КАК ЧИСЛО(15, 2)) КАК СуммаНДС,
	|	ВЫРАЗИТЬ(ВЫБОР
	|		КОГДА РасходыПриИмпортеЗапасыНДС.Ссылка.ВалютаДокумента = КонстантаНациональнаяВалюта.Значение
	|			ТОГДА РасходыПриИмпортеЗапасыНДС.СуммаНДС * КурсыРегВалюты.Курс * РасходыПриИмпортеЗапасыНДС.Ссылка.Кратность /
	|				(РасходыПриИмпортеЗапасыНДС.Ссылка.Курс * КурсыРегВалюты.Кратность)
