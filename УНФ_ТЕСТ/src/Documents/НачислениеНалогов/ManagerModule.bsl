...
Функция СформироватьКвитанцию(Данные, СуммаНалога = Неопределено) Экспорт
	...
	Если ВидВзаиморасчетов = Справочники.ВидыНалогов.АвансовыйПлатежПриУСН
		...
		СформироватьПлатежкуВНалоговую(Данные, Область, Результат, ВидВзаиморасчетов, СуммаНалога);
	...
	ИначеЕсли ВидВзаиморасчетов = Справочники.ВидыНалогов.ТорговыйСбор  Тогда
		СформироватьПлатежкуТорговыйСбор(Данные, Область, Результат);
...
Процедура СформироватьПлатежкуВНалоговую(Данные, ОбластьМакета, ТабличныйДокумент, ВидВзаиморасчетов, СуммаНалога) 
...
Процедура СформироватьПлатежкуТорговыйСбор(Данные, ОбластьМакета, ТабличныйДокумент) 
