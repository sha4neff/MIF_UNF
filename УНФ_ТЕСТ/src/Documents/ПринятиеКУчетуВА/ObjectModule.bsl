...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Номенклатура.ПроверятьЗаполнениеХарактеристики И Не ЗначениеЗаполнено(Характеристика)
		Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Для данной номенклатуры, заполнение поля ""характеристика"" является обезательным!'"));
		Отказ = Истина;
	КонецЕсли;
	
	Если Номенклатура.ПроверятьЗаполнениеПартий И Не ЗначениеЗаполнено(Партия)
		Тогда
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Для данной номенклатуры, заполнение поля ""партия"" является обезательным!'"));
		Отказ = Истина;
	КонецЕсли;
