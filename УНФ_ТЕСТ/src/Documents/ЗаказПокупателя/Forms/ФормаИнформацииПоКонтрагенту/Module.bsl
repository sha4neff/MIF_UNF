...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбластьМакета.Параметры.ТекстЗаголовка = "Данные контрагента по заказу с сайта №"
											+ ИнформацияПоЗаказу.НомерНаСайте
											+ " от "
											+ Формат(ИнформацияПоЗаказу.ДатаНаСайте, "ДЛФ=DD");
