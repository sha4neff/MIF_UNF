...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьСборкуЗаказов") Тогда
		Элементы.ОтборСборка.СписокВыбора.Добавить("Без сборки", "Без сборки");
		Элементы.ОтборСборка.СписокВыбора.Добавить("Собран частично", "Собран частично");
		Элементы.ОтборСборка.СписокВыбора.Добавить("Собран полностью", "Собран полностью");
	...
	УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(Список, "ВидОперации",
		ВидыОперацийЗаказПокупателя, Истина, ВидСравненияКомпоновкиДанных.ВСписке);
...
// @skip-warning обработчик ожидания см. СписокПриАктивизацииСтроки
&НаКлиенте
