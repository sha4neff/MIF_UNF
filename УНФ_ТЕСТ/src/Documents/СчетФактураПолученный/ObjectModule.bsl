...
Процедура ПроверитьДокументыОснованияСчетФактуры()
	...
	Для каждого ТекСтрока Из ДокументыОснования Цикл
		...
		НайденныйСчетФактура = УправлениеНебольшойФирмойСервер.ПолучитьПодчиненныйСчетФактуру(ТекСтрока.ДокументОснование, Истина);
...
Процедура ДозаполнениеНаОснованииКорректировкиПоступления(СтрокаТаблицы)
	...
	ДанныеСчетФактуры = УправлениеНебольшойФирмойСервер.ПолучитьПодчиненныйСчетФактуру(ДокументОснованиеСФ.ИсправляемыйДокументПоступления, Истина);
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЗначениеЗаполнено(УдалитьДокументОснование)
		...
		ТекстОшибки = СтрЗаменить(ТекстОшибки, "%ПредставлениеДокументаОснования%", """" + ТипЗнч(УдалитьДокументОснование) + " №" + УдалитьДокументОснование.Номер + " от " + УдалитьДокументОснование.Дата + """");
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ЗначениеЗаполнено(УдалитьДокументОснование) Тогда
		...
		Если ТипЗнч(УдалитьДокументОснование) <> Тип("ДокументСсылка.ОтчетКомитенту") Тогда
			...
			НайденныйСчетФактура = УправлениеНебольшойФирмойСервер.ПолучитьПодчиненныйСчетФактуру(УдалитьДокументОснование, Истина);
