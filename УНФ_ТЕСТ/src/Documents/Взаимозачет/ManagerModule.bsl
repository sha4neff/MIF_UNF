...
Процедура СформироватьТаблицаДоходыИРасходыНераспределенные(ДокументСсылкаВзаимозачет, СтруктураДополнительныеСвойства)
	...
	// Сначала заполним распрееделённые по остаткам значения
	...
	СтруктураДополнительныеСвойства.ТаблицыДляДвижений.Вставить("ТаблицаДоходыИРасходыНераспределенные", ТаблицаДоходыИРасходыНераспределенные);
...
Процедура СформироватьТаблицаДоходыИРасходыОтложенные(ДокументСсылкаВзаимозачет, СтруктураДополнительныеСвойства)
	...
	ТаблицаКредитор = МассивРезультатов[1].Выгрузить();
