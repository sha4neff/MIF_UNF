...
Функция ДанныеСотрудникаВоВременноеХранилище()	
	...
	ДанныеСотрудника.Вставить("ЯвляетсяСовместителем", ЯвляетсяСовместителем);
	...
	СписокСвойств = ДоступныеПоляВсехВидовМероприятий();
	...
	Для Каждого Мероприятие Из Мероприятия Цикл
		...
		ЗаполнитьЗначенияСвойств(СтруктураПолей, Мероприятие, СписокСвойств + "," + ДоступныеПоля[Мероприятие.ВидМероприятия]);
...
Процедура УстановитьВидимостьКолонок()
	...
	ДоступныеКолонки = СтрРазделить(ДоступныеПоляВсехВидовМероприятий(), ",");
...
&НаСервере 
Функция ДоступныеПоляВсехВидовМероприятий()
	
	Возврат ЭлектронныеТрудовыеКнижки.ДоступныеПоляВсехВидовМероприятий() + ",Идентификатор";
	
КонецФункции

&НаСервере 
Функция ДоступныеПоляВидовМероприятий()
	
	Возврат ЭлектронныеТрудовыеКнижки.ДоступныеПоляВидовМероприятий();
