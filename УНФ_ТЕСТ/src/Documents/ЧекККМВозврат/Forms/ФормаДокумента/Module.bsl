...
Процедура ПоискПоШтрихкодуЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли ДополнительныеПараметры.Свойство("ТекШтрихкод") Тогда
...
Процедура ЗаполнитьПараметрыМаркировкиНоменклатуры(ДанныеШтрихкода, ПараметрыМаркировки)
	...
	Если Номенклатура.ВидАлкогольнойПродукции.Маркируемый Тогда
	...
	ИначеЕсли Не Номенклатура.ВидПродукцииИС.Пустая() Тогда
...
Процедура ПослеВводаСуммыОплаты(Результат, ДополнительныеПараметры) Экспорт
	...
	Элементы.БезналичнаяОплата.ТекущиеДанные[ДополнительныеПараметры.ИмяКолонки] = Результат;
