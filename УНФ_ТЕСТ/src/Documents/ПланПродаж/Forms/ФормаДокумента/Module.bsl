...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УправлениеНебольшойФирмойСервер.НастроитьФормуОбъектаМобильныйКлиент(Элементы, "ТаблицаПланирования");
...
Процедура ДатаПриИзменении(Элемент)
	...
	СтруктураДанные = ПолучитьДанныеДатаПриИзменении(Объект.Дата, Объект.ВалютаДокумента);
	
	Если СтруктураДанные.ВалютаКурсКратность.Курс <> Объект.Курс ИЛИ СтруктураДанные.ВалютаКурсКратность.Кратность <> Объект.Кратность Тогда
		Объект.Курс = СтруктураДанные.ВалютаКурсКратность.Курс;
		Объект.Кратность = СтруктураДанные.ВалютаКурсКратность.Кратность;
...
//
Функция ПолучитьДанныеДатаПриИзменении(ДатаНовая, ВалютаРасчетов)
