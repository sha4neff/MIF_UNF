...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступнаРаботаСЛидами = РольДоступна("ПолныеПрава") Или РольДоступна("ДобавлениеИзменениеЛидов");
...
Процедура СоздатьЛид(Команда)
	...
	ПараметрыФормы.Вставить("ЗначенияЗаполнения", ЗначенияЗаполнения);
	ОткрытьФорму("Справочник.Лиды.ФормаОбъекта", ПараметрыФормы, ЭтотОбъект,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ОбновитьДанныеЗвонкаСервер()
	...
	Ответственный = ДанныеЗвонка.Пользователь.Сотрудник;
