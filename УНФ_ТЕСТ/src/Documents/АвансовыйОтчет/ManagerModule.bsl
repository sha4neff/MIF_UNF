...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаАвансовыйОтчет, СтруктураДополнительныеСвойства) Экспорт
	...
	|		АвансовыйОтчетРасходы.Ссылка.Проект КАК Проект
	|	ИЗ
...
Функция ДанныеПолученныхДокументовРегУчет(МассивОбъектов, ИспользоватьФаксимиле, ПечатнаяФормаТолькоВРублях = Истина, Ошибки = Неопределено) Экспорт
	...
	|ИЗ Документ.АвансовыйОтчет.Запасы КАК АвансовыйОтчетЗапасы
	|ГДЕ АвансовыйОтчетЗапасы.Ссылка В(&МассивОбъектов)
	|СГРУППИРОВАТЬ ПО АвансовыйОтчетЗапасы.Ссылка
	...
	|	,Выбор КОГДА АвансовыйОтчет.СчетФактураКонтрагент.ГоловнойКонтрагент <> Значение(Справочник.Контрагенты.ПустаяСсылка)
	|		ТОГДА АвансовыйОтчет.СчетФактураКонтрагент.ГоловнойКонтрагент
	|		ИНАЧЕ АвансовыйОтчет.СчетФактураКонтрагент КОНЕЦ КАК Организация
	...
	|	,Выбор КОГДА АвансовыйОтчет.СчетФактураКонтрагент.ВидКонтрагента = Значение(Перечисление.ВидыКонтрагентов.ФизическоеЛицо)
	|		ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ КОНЕЦ КАК ЭтоФизическоеЛицо
	|	,Выбор КОГДА АвансовыйОтчет.НалогообложениеНДС = Значение(Перечисление.ТипыНалогообложенияНДС.НеОблагаетсяНДС)
	|		ТОГДА 2
	...
	|	,Выбор КОГДА АвансовыйОтчет.Организация.ГоловнаяОрганизация <> Значение(Справочник.Организации.ПустаяСсылка)
	|		ТОГДА АвансовыйОтчет.Организация.ГоловнаяОрганизация
	|		ИНАЧЕ АвансовыйОтчет.Организация КОНЕЦ КАК Контрагент
	...
	|		ИНАЧЕ АвансовыйОтчет.ВалютаДокумента КОНЕЦ КАК ВалютаДокумента
	|	,Выбор КОГДА &ПечатнаяФормаТолькоВРублях = ИСТИНА 
	|		ТОГДА НациональнаяВалюта.Значение.НаименованиеПолное
	|		ИНАЧЕ АвансовыйОтчет.ВалютаДокумента.НаименованиеПолное КОНЕЦ КАК ВалютаНаименование
	|	,Выбор КОГДА &ПечатнаяФормаТолькоВРублях = ИСТИНА 
	|		ТОГДА НациональнаяВалюта.Значение.Код
	|		ИНАЧЕ АвансовыйОтчет.ВалютаДокумента.Код КОНЕЦ КАК ВалютаКод
	...
	|		,Выбор КОГДА ВЫРАЗИТЬ(АвансовыйОтчет.Запасы.Номенклатура.НаименованиеПолное КАК СТРОКА(1000)) = """"
	|			ТОГДА АвансовыйОтчет.Запасы.Номенклатура.Наименование
	|			ИНАЧЕ ВЫРАЗИТЬ(АвансовыйОтчет.Запасы.Номенклатура.НаименованиеПолное КАК СТРОКА(1000)) КОНЕЦ КАК ПредставлениеНоменклатуры
	...
	|		,Выбор КОГДА АвансовыйОтчет.Запасы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	...
	|				ИНАЧЕ АвансовыйОтчет.Запасы.Номенклатура.ЕдиницаИзмерения.Наименование КОНЕЦ КАК ЕдиницаИзмеренияПоОКЕИ_Наименование
	|		,Выбор КОГДА АвансовыйОтчет.Запасы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	|			И ПечатьПользовательскихЕдиницИзмерения.Значение = ЗНАЧЕНИЕ(Перечисление.ПечатьПользовательскихЕдиницИзмерения.ФормироватьПечатныйДокументВПользовательскойЕдинице)
	|			И АвансовыйОтчет.Запасы.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору <> ЗНАЧЕНИЕ(Справочник.КлассификаторЕдиницИзмерения.ПустаяСсылка)
	|				ТОГДА АвансовыйОтчет.Запасы.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору.Код
	|				ИНАЧЕ АвансовыйОтчет.Запасы.Номенклатура.ЕдиницаИзмерения.Код КОНЕЦ КАК ЕдиницаИзмеренияПоОКЕИ_Код
	|		,Выбор КОГДА АвансовыйОтчет.Запасы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	|			И ПечатьПользовательскихЕдиницИзмерения.Значение = ЗНАЧЕНИЕ(Перечисление.ПечатьПользовательскихЕдиницИзмерения.ФормироватьПечатныйДокументВПользовательскойЕдинице)
	|			И АвансовыйОтчет.Запасы.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору <> ЗНАЧЕНИЕ(Справочник.КлассификаторЕдиницИзмерения.ПустаяСсылка)
	|				ТОГДА АвансовыйОтчет.Запасы.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору
	|				ИНАЧЕ АвансовыйОтчет.Запасы.Номенклатура.ЕдиницаИзмерения КОНЕЦ КАК ЕдиницаИзмерения
	...
	|				ТОГДА 1
	|				ИНАЧЕ АвансовыйОтчет.Запасы.ЕдиницаИзмерения.Коэффициент КОНЕЦ КАК КоличествоВОдномМесте
	|		,Выбор КОГДА АвансовыйОтчет.Запасы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	|			И ПечатьПользовательскихЕдиницИзмерения.Значение <> ЗНАЧЕНИЕ(Перечисление.ПечатьПользовательскихЕдиницИзмерения.ФормироватьПечатныйДокументВПользовательскойЕдинице)
	|				ТОГДА АвансовыйОтчет.Запасы.ЕдиницаИзмерения.Коэффициент
	|				ИНАЧЕ 1 КОНЕЦ КАК КоэффициентЕдиницыИзмерения
	|		,АвансовыйОтчет.Запасы.Количество КАК КоличествоМест
	|		,Количество КАК Количество
	|		,СтавкаНДС КАК СтавкаНДС
	|		,0 КАК МассаБрутто
	|		,Выбор КОГДА &ПечатнаяФормаТолькоВРублях = ИСТИНА
	|				ИЛИ (Ссылка.СчетФактураДоговорКонтрагента.РасчетыВУсловныхЕдиницах = ИСТИНА
	...
	|		,Номенклатура КАК Номенклатура
	|		,Содержание КАК Содержание
	|		,Выбор КОГДА ВЫРАЗИТЬ(АвансовыйОтчет.Расходы.Номенклатура.НаименованиеПолное КАК СТРОКА(1000)) = """"
	|			ТОГДА АвансовыйОтчет.Расходы.Номенклатура.Наименование
	|			ИНАЧЕ ВЫРАЗИТЬ(АвансовыйОтчет.Расходы.Номенклатура.НаименованиеПолное КАК СТРОКА(1000)) КОНЕЦ КАК ПредставлениеНоменклатуры
	|		,Номенклатура.ТипНоменклатуры КАК ТипНоменклатуры
	|		,Номенклатура.Код КАК ЗапасКод
	|		,Номенклатура.Код КАК Код
	|		,Номенклатура.Артикул КАК Артикул
	...
	|		,Выбор КОГДА АвансовыйОтчет.Расходы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	|			И ПечатьПользовательскихЕдиницИзмерения.Значение = ЗНАЧЕНИЕ(Перечисление.ПечатьПользовательскихЕдиницИзмерения.ФормироватьПечатныйДокументВПользовательскойЕдинице)
	...
	|				ИНАЧЕ АвансовыйОтчет.Расходы.Номенклатура.ЕдиницаИзмерения.Наименование КОНЕЦ КАК ЕдиницаИзмеренияПоОКЕИ_Наименование
	|		,Выбор КОГДА АвансовыйОтчет.Расходы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	|			И ПечатьПользовательскихЕдиницИзмерения.Значение = ЗНАЧЕНИЕ(Перечисление.ПечатьПользовательскихЕдиницИзмерения.ФормироватьПечатныйДокументВПользовательскойЕдинице)
	|			И АвансовыйОтчет.Расходы.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору <> ЗНАЧЕНИЕ(Справочник.КлассификаторЕдиницИзмерения.ПустаяСсылка)
	|				ТОГДА АвансовыйОтчет.Расходы.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору.Код
	|				ИНАЧЕ АвансовыйОтчет.Расходы.Номенклатура.ЕдиницаИзмерения.Код КОНЕЦ КАК ЕдиницаИзмеренияПоОКЕИ_Код
	|		,Выбор КОГДА АвансовыйОтчет.Расходы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	|			И ПечатьПользовательскихЕдиницИзмерения.Значение = ЗНАЧЕНИЕ(Перечисление.ПечатьПользовательскихЕдиницИзмерения.ФормироватьПечатныйДокументВПользовательскойЕдинице)
	|			И АвансовыйОтчет.Расходы.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору <> ЗНАЧЕНИЕ(Справочник.КлассификаторЕдиницИзмерения.ПустаяСсылка)
	|				ТОГДА АвансовыйОтчет.Расходы.ЕдиницаИзмерения.ЕдиницаИзмеренияПоКлассификатору
	|				ИНАЧЕ АвансовыйОтчет.Расходы.Номенклатура.ЕдиницаИзмерения КОНЕЦ КАК ЕдиницаИзмерения
	|		,Выбор КОГДА АвансовыйОтчет.Расходы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	|			И ПечатьПользовательскихЕдиницИзмерения.Значение <> ЗНАЧЕНИЕ(Перечисление.ПечатьПользовательскихЕдиницИзмерения.ФормироватьПечатныйДокументВПользовательскойЕдинице)
	...
	|ГДЕ АвансовыйОтчет.Ссылка В(&МассивОбъектов)
	|УПОРЯДОЧИТЬ ПО АвансовыйОтчет.Запасы.НомерСтроки";
