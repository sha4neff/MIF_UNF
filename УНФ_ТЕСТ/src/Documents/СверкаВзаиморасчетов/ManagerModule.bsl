...
Функция ОписаниеСчетаФактуры(ДокументСсылка) Экспорт
	...
	ОписаниеСчетФактуры = УправлениеНебольшойФирмойСервер.ПолучитьПодчиненныйСчетФактуру(ДокументСсылка, ЭтоВходящийДокумент);
...
Функция СформироватьПечатнуюФормуАктБезРасхождений(ОписаниеПечатнойФормы, ДокументПечати, ОбъектыПечати, ИспользоватьФаксимиле)
	...
	Пока ВыборкаДокументов.Следующий() Цикл
		...
		ПолноеНаименованиеОрганизации = УправлениеНебольшойФирмойСервер.ОписаниеОрганизации(СведенияОбОрганизации, "ПолноеНаименование");
		...
		ПолноеНаименованиеКонтрагента = УправлениеНебольшойФирмойСервер.ОписаниеОрганизации(СведенияОКонтрагенте, "ПолноеНаименование");
