...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	ПараметрыЗаписи.ПараметрыОповещения.ПредставлениеСчетФактуры = УправлениеНебольшойФирмойКлиент.ПредставлениеСчетаФактуры(Объект.Дата, Объект.Номер);
...
Процедура КонтрагентПриИзменении(Элемент)
	...
	Иначе
		...
		Объект.Договор = КэшЗначений.ДоговорТекущий; // Восстанавливаем автоматически очищеный договор.
