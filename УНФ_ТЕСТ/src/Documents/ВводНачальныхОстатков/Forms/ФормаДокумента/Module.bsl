...
Процедура СформироватьСписокРазделовУчета()
	...
	Если ЗначениеЗаполнено(Объект.Организация) Тогда
		...
		Если РеквизитыОрганизации.ИспользуетсяОтчетность И УСНДоходыРасходы
			...
			Элементы.РазделУчета.СписокВыбора.Добавить("Закупки товаров для УСН", "Закупки товаров для УСН");
		КонецЕсли;
		...
		Если РеквизитыОрганизации.ИспользуетсяОтчетность И РеквизитыОрганизации.ИПИспользуетТрудНаемныхРаботников
			...
			Элементы.РазделУчета.СписокВыбора.Добавить("Расчеты с фондами по страховым взносам", "Расчеты с фондами по страховым взносам");
		КонецЕсли;
	КонецЕсли;
