...
Процедура ЗаполнитьПоОперацияПоПлатежнымКартам(ДокументСсылкаОперацияПоПлатежнымКартам) Экспорт
	...
	КомиссияЗаВозвратУменьшаетКомиссиюЗаОплату = ЭквайринговыйТерминал.КомиссияЗаВозвратУменьшаетКомиссиюЗаОплату;
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	РасчетКомиссиВОтчетеЭквайера = ЭквайринговыйТерминал.Договор.РасчетКомиссиВОтчетеЭквайера;
	
	Если РасчетКомиссиВОтчетеЭквайера ИЛИ (ВидОперации = Перечисления.ВидыОперацийЭквайринга.ВозвратОплатыПокупателю И НЕ ЭквайрерБеретКомиссиюЗаВозвратДС) Тогда
