...
Процедура СформироватьТаблицаПотребностьВЗапасах(ДокументСсылкаРаспределениеЗатрат, СтруктураДополнительныеСвойства)
	...
	|	ВЫБОР
	|		КОГДА &ИспользоватьРезервирование
	|				И ТаблицаПотребностьВЗапасах.ЗаказНаПроизводство.УчетПотребностиПоЗаказамНаПроизводство
	|			ТОГДА ТаблицаПотребностьВЗапасах.ЗаказНаПроизводство
	...
	|						ВЫБОР
	|							КОГДА &ИспользоватьРезервирование
	|								ТОГДА ВременнаяТаблицаЗапасы.ЗаказПокупателя
	|							ИНАЧЕ ЗНАЧЕНИЕ(Документ.ЗаказПокупателя.ПустаяСсылка)
	|						КОНЕЦ КАК ЗаказПокупателя,
	|						ВЫБОР
	|							КОГДА &ИспользоватьРезервирование
	|									И ВременнаяТаблицаЗапасы.ЗаказНаПроизводство.УчетПотребностиПоЗаказамНаПроизводство
	|								ТОГДА ВременнаяТаблицаЗапасы.ЗаказНаПроизводство
	|							ИНАЧЕ ЗНАЧЕНИЕ(Документ.ЗаказНаПроизводство.ПустаяСсылка)
	|						КОНЕЦ КАК ЗаказНаПроизводство,
...
Процедура ИнициализироватьДанныеПоЗапасам(ДокументСсылкаРаспределениеЗатрат, СтруктураДополнительныеСвойства) Экспорт
	...
	|	ДокументРаспределениеЗатрат.ЗаказНаПроизводство.УчетПотребностиПоЗаказамНаПроизводство КАК УчетПотребностиПоЗаказамНаПроизводство,
	...
	|	ВЫБОР
	|		КОГДА &ИспользоватьРезервирование
	|				И ТаблицаЗапасы.УчетПотребностиПоЗаказамНаПроизводство
