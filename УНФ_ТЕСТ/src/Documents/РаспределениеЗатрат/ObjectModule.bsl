	...
	Для каждого СтрокаТабличнойЧасти Из Запасы Цикл
		...
		Для каждого СтрокаМассива Из МассивПоиска Цикл
			...
			Если КоличествоКРаспределению > 0 Тогда
				...
				СтрокаКоличество = Мин(Окр(СтрокаТабличнойЧасти.Количество*СтрокаМассива.Количество/СтрокаМассива.ВсегоКоличество,3), КоличествоКРаспределению);
		...
		Если МассивПоиска.Количество()=0 Тогда
			...
			Для каждого СтрокаМассива Из ВременнаяТаблицаПродукция Цикл
				...
				Если КоличествоКРаспределению > 0 Тогда
					...
					СтрокаКоличество = Мин(Окр(СтрокаТабличнойЧасти.Количество*СтрокаМассива.Количество/ВсегоКоличествоПродукции,3), КоличествоКРаспределению);
					КоличествоКРаспределению = КоличествоКРаспределению - СтрокаКоличество;
