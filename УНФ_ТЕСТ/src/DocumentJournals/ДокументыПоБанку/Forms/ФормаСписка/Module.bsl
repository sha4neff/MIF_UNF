...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДвижениеДенежныхСредствСервер.СформироватьСписокКомандСозданияДокументов(ЭтотОбъект, "СписокСоздатьПоступление", "ПоступлениеНаСчет", "БанковскиеВыписки");
	ДвижениеДенежныхСредствСервер.СформироватьСписокКомандСозданияДокументов(ЭтотОбъект, "СписокСоздатьРасход", "РасходСоСчета", "БанковскиеВыписки");
