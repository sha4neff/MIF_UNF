...
&НаКлиенте
Процедура Закупка(Команда)
	
	// Сбор статистики
	СборСтатистикиМПКлиентСерверПереопределяемый.ОтправитьДействиеВGA(ЭтаФорма.ИмяФормы + ".Команда." + Команда.Имя);
	// Конец Сбор статистики

	ОткрытьФорму("Документ.ПриходТовараМП.ФормаОбъекта", , ЭтаФорма, Истина);
...
Процедура Продажа(Команда)
	...
	ОткрытьФорму("Документ.РасходТовараМП.ФормаОбъекта", , ЭтаФорма, Истина);
