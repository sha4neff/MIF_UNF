...
Процедура ОтборВыбранныеНаСервере()
	...
	УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(Номенклатура, "Выбран", Истина, Истина, ВидСравненияКомпоновкиДанных.Равно);
...
Процедура ОтборНЕВыбранныеНаСервере()
	...
	ОбновитьВыбранныеТовары(Истина);
	УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(Номенклатура, "Выбран", Ложь, Истина, ВидСравненияКомпоновкиДанных.Равно);
...
Процедура ОтборВсеНаСервере()
	...
	ОбновитьВыбранныеТовары(Истина);
	УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(Номенклатура, "Выбран", Истина, Ложь, ВидСравненияКомпоновкиДанных.Равно);
