...
Процедура ПередУдалением(Отказ)
	...
	РегламентноеЗадание = ОбменССайтомРегламентныеЗадания.НайтиЗадание(ИдентификаторРегламентногоЗадания);
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если НЕ ОбменТоварами
		И НЕ ОбменЗаказами
		И НЕ ОбменЗаписьНаУслуги Тогда
...
Процедура ДобавитьПроверяемыеРеквизиты(ПроверяемыеРеквизиты)
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьНесколькоОрганизаций") И (ОнлайнОплаты ИЛИ ПодчиненныеДокументы) Тогда
	
		ПроверяемыеРеквизиты.Добавить("ОрганизацияДляПодстановкиВЗаказы");
		
	Иначе
		РеквизитОплат = ПроверяемыеРеквизиты.Найти("СоответствиеВидовОплат.АналитикаОплаты");
		Если РеквизитОплат <> Неопределено Тогда
			ПроверяемыеРеквизиты.Удалить(РеквизитОплат);
		КонецЕсли;
		РеквизитОплат = ПроверяемыеРеквизиты.Найти("СоответствиеВидовОплат.СпособОплатыНаСайте");
		Если РеквизитОплат <> Неопределено Тогда
			ПроверяемыеРеквизиты.Удалить(РеквизитОплат);
		КонецЕсли;
	КонецЕсли;
