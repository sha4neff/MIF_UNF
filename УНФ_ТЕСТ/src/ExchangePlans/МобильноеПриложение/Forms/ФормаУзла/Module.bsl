...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	КонецЕсли;
	Если Розница = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Включена") Тогда
		ДобавитьРольВТаблицу(ПредопределенноеЗначение("Перечисление.РолиМобильногоПриложения.РозницаПросмотрИРедактирование"));
	ИначеЕсли Розница = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.ТолькоПросмотр") Тогда
		ДобавитьРольВТаблицу(ПредопределенноеЗначение("Перечисление.РолиМобильногоПриложения.РозницаТолькоПросмотр"));
	КонецЕсли;
	Если ИнформацияОКомпании = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Включена") Тогда
		ДобавитьРольВТаблицу(ПредопределенноеЗначение("Перечисление.РолиМобильногоПриложения.ИнформацияОКомпанииПросмотрИРедактирование"));
	ИначеЕсли ИнформацияОКомпании = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.ТолькоПросмотр") Тогда
		ДобавитьРольВТаблицу(ПредопределенноеЗначение("Перечисление.РолиМобильногоПриложения.ИнформацияОКомпанииТолькоПросмотр"));
	КонецЕсли;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Розница = Перечисления.ЗначениеРоли.Выключена;
	ИнформацияОКомпании = Перечисления.ЗначениеРоли.Выключена;
	...
	Для каждого ТекСтрока Из Объект.Роли Цикл
		...
		ИначеЕсли ТекСтрока.Роль = Перечисления.РолиМобильногоПриложения.РозницаПросмотрИРедактирование Тогда
			Розница = Перечисления.ЗначениеРоли.Включена;
		ИначеЕсли ТекСтрока.Роль = Перечисления.РолиМобильногоПриложения.РозницаТолькоПросмотр Тогда
			Розница = Перечисления.ЗначениеРоли.ТолькоПросмотр;
		ИначеЕсли ТекСтрока.Роль = Перечисления.РолиМобильногоПриложения.ИнформацияОКомпанииПросмотрИРедактирование Тогда
			ИнформацияОКомпании = Перечисления.ЗначениеРоли.Включена;
		ИначеЕсли ТекСтрока.Роль = Перечисления.РолиМобильногоПриложения.ИнформацияОКомпанииТолькоПросмотр Тогда
			ИнформацияОКомпании = Перечисления.ЗначениеРоли.ТолькоПросмотр;
		КонецЕсли;
	...
	Если НЕ ОбменМобильноеПриложениеОбщее.ЭтоВерсияСПроизводством(Объект.Ссылка) Тогда
		Элементы.Производство.Видимость = Ложь;
	КонецЕсли;
	
	Если ОбменМобильноеПриложениеОбщее.ЭтоВерсияСРозницей(Объект.Ссылка) Тогда
		Элементы.Профиль.СписокВыбора.Добавить(Перечисления.ПрофилиМобильногоПриложения.РозничнаяТочка);
	Иначе
		Элементы.Розница.Видимость = Ложь;
		Элементы.КассаККМ.Видимость = Ложь;
		Элементы.ИнформацияОКомпании.Видимость = Ложь;
	КонецЕсли;
	
	Если Объект.Профиль = Перечисления.ПрофилиМобильногоПриложения.МобильнаяТелефония Тогда
		Элементы.Профиль.ТолькоПросмотр = Истина;
		Элементы.ИнформацияОКомпании.Видимость = Ложь;
		Элементы.Номенклатура.Видимость = Ложь;
		Элементы.Заказы.Видимость = Ложь;
		Элементы.ДвиженияДенег.Видимость = Ложь;
		Элементы.ДвиженияТоваров.Видимость = Ложь;
		Элементы.Производство.Видимость = Ложь;
		Элементы.Розница.Видимость = Ложь;
		Элементы.ОтчетОстаткиТоваров.Видимость = Ложь;
		Элементы.ОтчетДвижениеДенег.Видимость = Ложь;
		Элементы.ОтчетПродажи.Видимость = Ложь;
		Элементы.ОтчетДолги.Видимость = Ложь;
		Элементы.НалоговыйКалендарь.Видимость = Ложь;
		Элементы.КассаККМ.Видимость = Ложь;
		Элементы.КассаККМСтруктурнаяЕдиница.Видимость = Ложь;
		Элементы.ПоВсемКассамККМ.Видимость = Ложь;
		Элементы.ПоОтветственному.Видимость = Ложь;
		Элементы.Профиль.СписокВыбора.Добавить(Перечисления.ПрофилиМобильногоПриложения.МобильнаяТелефония);
	КонецЕсли;
	
	Элементы.Профиль.СписокВыбора.Добавить(Перечисления.ПрофилиМобильногоПриложения.ДетальнаяНастройка);
...
&НаКлиенте
Процедура РозницаПриИзменении(Элемент)
...
Процедура УстановитьРолиПоПрофилю()
	...
	Если Объект.Профиль = ПредопределенноеЗначение("Перечисление.ПрофилиМобильногоПриложения.Собственник") Тогда
		...
		Розница = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Включена");
		ИнформацияОКомпании = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Включена");
	...
	ИначеЕсли Объект.Профиль = ПредопределенноеЗначение("Перечисление.ПрофилиМобильногоПриложения.Продавец") Тогда
		...
		Розница = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Выключена");
		ИнформацияОКомпании = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.ТолькоПросмотр");
	...
	ИначеЕсли Объект.Профиль = ПредопределенноеЗначение("Перечисление.ПрофилиМобильногоПриложения.СервисныйИнженер") Тогда
		...
		ИнформацияОКомпании = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.ТолькоПросмотр");
		Объект.ПоОтветственному = Истина;
	ИначеЕсли Объект.Профиль = ПредопределенноеЗначение("Перечисление.ПрофилиМобильногоПриложения.РозничнаяТочка") Тогда
		Контрагенты = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Выключена");
		Номенклатура = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.ТолькоПросмотр");
		Заказы = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Выключена");
		ДвиженияДенег = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Выключена");
		ДвиженияТоваров = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Выключена");
		ОтчетДвиженияДенег = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Выключена");
		ОтчетОстаткиТоваровНаСкладах = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Выключена");
		ОтчетПродажи = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Включена");
		ОтчетДолги = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Выключена");
		НалоговыйКалендарь = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Выключена");
		Производство = ПредопределенноеЗначение("Перечисление.ЗначениеРоли.Выключена");
