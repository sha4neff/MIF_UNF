...
Процедура ОбновитьНастройкиНаФорме(НастройкиОтчета, НастройкиСКД, Форма) Экспорт
	...
	ЗначениеПараметра = НастройкиСКД.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("СостояниеОтгрузки"));
	...
	"Все заказы,Неотгруженные,Отгруженные частично,Без полной отгрузки,Отгруженные полностью",
	ЗначениеПоУмолчанию);
