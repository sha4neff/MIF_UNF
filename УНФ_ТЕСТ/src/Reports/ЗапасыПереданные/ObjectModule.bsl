...
Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	...
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["Ведомость"].СвязанныеПоля, "Контрагент", "Документ.ОтчетКомиссионера",,, Истина);
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["Остатки"].СвязанныеПоля, "Контрагент", "Документ.ОтчетКомиссионера",,, Истина);
