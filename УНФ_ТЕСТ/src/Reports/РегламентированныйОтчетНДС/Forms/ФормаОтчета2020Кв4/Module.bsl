...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "П000100008503", 2, , "Выбор признака СЗПК", КоллекцияСписковВыбора["ПризнакиСЗПК"]);
...
Процедура ВывестиНаПечатьЛист(Парам1, ОбщиеРеквизитыРазделов, СтрПоля = Неопределено, НомерДопСтраницы = 1)
	...
	СоответствиеРазделовМакетам.Вставить("Титульный",     "ПечатныйБланк2020Кв4_Титульный");
	СоответствиеРазделовМакетам.Вставить("Раздел1",       "ПечатныйБланк2020Кв4_Раздел1");
	СоответствиеРазделовМакетам.Вставить("Раздел2",       "ПечатныйБланк2020Кв4_Раздел2");
	СоответствиеРазделовМакетам.Вставить("Раздел3",       "ПечатныйБланк2020Кв4_Раздел3");
	СоответствиеРазделовМакетам.Вставить("Раздел3_Прил1", "ПечатныйБланк2020Кв4_Раздел3_Прил1");
	СоответствиеРазделовМакетам.Вставить("Раздел3_Прил2", "ПечатныйБланк2020Кв4_Раздел3_Прил2");
	СоответствиеРазделовМакетам.Вставить("Раздел4",       "ПечатныйБланк2020Кв4_Раздел4");
	СоответствиеРазделовМакетам.Вставить("Раздел5",       "ПечатныйБланк2020Кв4_Раздел5");
	СоответствиеРазделовМакетам.Вставить("Раздел6",       "ПечатныйБланк2020Кв4_Раздел6");
	СоответствиеРазделовМакетам.Вставить("Раздел7",       "ПечатныйБланк2020Кв4_Раздел7");
	...
	Для Каждого Запись Из Данные.Записи Цикл
		...
		Если Парам1.ИмяСтраницы = "Раздел8" Тогда
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел8 = 1
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел8";
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел8_Прод";
		...
		ИначеЕсли Парам1.ИмяСтраницы = "Раздел8_Прил1" Тогда
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел8_Прил1 = 1
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел8_Прил1";
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел8_Прил1_Прод";
		...
		ИначеЕсли Парам1.ИмяСтраницы = "Раздел9" Тогда
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел9 = 1
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел9";
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел9_Прод1";
				...
				Если ВыводитьНаПечать_Раздел9_Прод2 Тогда
					...
					МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел9_Прод2";
		...
		ИначеЕсли Парам1.ИмяСтраницы = "Раздел9_Прил1" Тогда
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел9_Прил1 = 1
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел9_Прил1";
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел9_Прил1_Прод1";
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел9_Прил1_Прод2";
				...
				Если ВыводитьНаПечать_Раздел9_Прил1_Прод3 Тогда
					...
					МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел9_Прил1_Прод3";
		...
		ИначеЕсли Парам1.ИмяСтраницы = "Раздел10" Тогда
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел10 = 1
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел10";
				...
				Для Каждого Сведения Из Запись.СвСчФОтПрод Цикл
					...
					МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел10_Прод";
		...
		ИначеЕсли Парам1.ИмяСтраницы = "Раздел11" Тогда
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел11 = 1
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел11";
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел11_Прод";
		...
		ИначеЕсли Парам1.ИмяСтраницы = "Раздел12" Тогда
			...
			Если Запись <> "" И НЕ (СтруктураРеквизитовФормы.АктуальностьСведенийРаздел12 = 1
				...
				МЧБРаздела = "ПечатныйБланк2020Кв4_Раздел12";
