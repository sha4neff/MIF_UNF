...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ru = 'Запасы,Закупки,Номенклатура,Товары,ГТД,Принятые'");
	НастройкиВариантов["Остатки"].Теги = НСТР("ru = 'Запасы,Закупки,Номенклатура,Товары,ГТД,Принятые'");
