...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	ИменаПолей = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок("СуммаОстаток,СуммаОстатокДт,СуммаОстатокКт");
	Для каждого НастройкиВарианта Из НастройкиВариантов Цикл
		Для каждого ИмяПоля Из ИменаПолей Цикл
			ОтчетыУНФ.ДобавитьВариантыОформленияСумм(НастройкиВарианта.Значение.ВариантыОформления, ИмяПоля);
		КонецЦикла; 
	КонецЦикла; 
...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ПараметрЗаголовок = НастройкиОтчета.ПараметрыВывода.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Заголовок"));
	Если ПараметрЗаголовок<>Неопределено И ПараметрЗаголовок.Использование Тогда
		ДокументРезультат.Область(ДокументРезультат.ВысотаТаблицы, 1, ДокументРезультат.ВысотаТаблицы, 1).Текст = ПараметрЗаголовок.Значение;
	КонецЕсли; 
