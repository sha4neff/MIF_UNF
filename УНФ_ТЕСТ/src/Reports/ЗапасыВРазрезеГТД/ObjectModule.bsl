...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ru = 'Запасы,Закупки,Продажи,Номенклатура,Товары,ГТД'");
	НастройкиВариантов["Остатки"].Теги = НСТР("ru = 'Запасы,Закупки,Продажи,Номенклатура,Товары,ГТД'");
