...
Процедура ГиперссылкаСайтБухНажатие(Элемент)
	Попытка
		ПерейтиПоНавигационнойСсылке("https://buh.ru/articles/documents/121431/");
	Исключение
