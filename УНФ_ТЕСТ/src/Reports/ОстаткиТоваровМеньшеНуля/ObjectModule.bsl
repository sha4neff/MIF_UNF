...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиОтчета.ПоляСебестоимости = "Себестоимость";
...
Процедура ОбновитьНастройкиНаФорме(НастройкиОтчета, НастройкиСКД, Форма) Экспорт
	...
	Группа = Форма.Элементы.Вставить("ГруппаФильтр"+Идентификатор, Тип("ГруппаФормы"), Форма.Элементы.ОбластьНастроек, Форма.Элементы.ГруппаПараметры);
