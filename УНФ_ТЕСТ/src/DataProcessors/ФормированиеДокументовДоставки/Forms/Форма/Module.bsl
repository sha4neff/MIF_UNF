...
Функция ТекстЗапросаДеревоЗаказов()
	...
	|		ЗаказыПокупателейОбороты.Регистратор) КАК Отгрузка
	|
	|СГРУППИРОВАТЬ ПО
	|	Отгрузка.Заказ,
...
Процедура ПланДоставкиИзменитьСтроки(Команда)
	...
	Если Элементы.ГруппаПланДоставкиИзменениеСтрок.Видимость И Не ЗначениеЗаполнено(ПланДоставкиИзменениеСтрокДействие) Тогда
		ПланДоставкиИзменениеСтрокДействие = ПредопределенноеЗначение("Перечисление.ДействияГрупповогоИзмененияСтрок.УстновитьСостояниеДоставки");
...
Процедура ПланДоставкиИзменениеСтрокЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ДанныеВыбора = Новый СписокЗначений;
	Если ПланДоставкиИзменениеСтрокДействие = ПредопределенноеЗначение("Перечисление.ДействияГрупповогоИзмененияСтрок.УстновитьСостояниеОплаты") Тогда
		ДанныеВыбора.Добавить(ПредопределенноеЗначение("Перечисление.СостоянияОплатыЗаказа.НеОплачен"));
		ДанныеВыбора.Добавить(ПредопределенноеЗначение("Перечисление.СостоянияОплатыЗаказа.ОплаченНаличными"));
		ДанныеВыбора.Добавить(ПредопределенноеЗначение("Перечисление.СостоянияОплатыЗаказа.ОплаченКартой"));
	Иначе
...
Процедура ОбработатьСтрокуТаблицы(ТекущаяСтрока)
	...
	Если ПланДоставкиИзменениеСтрокДействие = ПредопределенноеЗначение("Перечисление.ДействияГрупповогоИзмененияСтрок.УстновитьСостояниеДоставки") Тогда
	...
	ИначеЕсли ПланДоставкиИзменениеСтрокДействие = ПредопределенноеЗначение("Перечисление.ДействияГрупповогоИзмененияСтрок.УстновитьСостояниеОплаты") Тогда
...
Процедура ЗаполнитьСписокДействий(ИмяТЧ)
	...
	Действия.Добавить(Перечисления.ДействияГрупповогоИзмененияСтрок.УстновитьСостояниеДоставки);
	Действия.Добавить(Перечисления.ДействияГрупповогоИзмененияСтрок.УстновитьСостояниеОплаты);
