...
Процедура НастроитьПанелиОтборов()
	...
	ОтборПП = "ОтборВидОперацииПП,ОтборКонтрагентПП,ОтборСчет,ОтборВалютаПП,ОтборАвторПП,ОтборОрганизацияПП";
	ОтборЭ  = "ОтборВидОперацииЭ,ОтборЭквайрер,ОтборКонтрагент,ОтборЭквайринговыйТерминал,ОтборАвторЭ,ОтборОрганизацияЭ";
