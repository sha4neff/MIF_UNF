...
Процедура СтруктураСведенийОДокументе(СтруктураПараметров) Экспорт
	...
	Для каждого РеквизитОбработки Из Метаданные.Обработки.ПодборПечатьЭтикетокИЦенников.Реквизиты Цикл
...
Функция СтруктураОбязательныхПараметров()
	...
	Возврат Новый Структура("Дата, Организация, УникальныйИдентификаторФормыВладельца, ВидЦен", "Дата", "Организация", "Уникальный идентификатор формы владельца", "Вид цены");
...
Функция ПолноеИмяФормыПодбора() Экспорт
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		Возврат "Обработка.ПодборПечатьЭтикетокИЦенников.Форма.КорзинаЦенаОстатокРезервХарактеристика_МК";
	Иначе
		Возврат "Обработка.ПодборПечатьЭтикетокИЦенников.Форма.КорзинаЦенаОстатокРезервХарактеристика";
	КонецЕсли;
