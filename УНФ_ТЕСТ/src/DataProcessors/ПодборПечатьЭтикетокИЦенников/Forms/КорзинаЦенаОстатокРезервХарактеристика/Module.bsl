...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КешНастройкиПодбора.Вставить("ВидЦенЦенаВключаетНДС", Объект.ВидЦен.ЦенаВключаетНДС);
	КешНастройкиПодбора.Вставить("СкидкиНаценкиВидны", Ложь);
	КешНастройкиПодбора.Вставить("ПроцентСкидкиНаценки", 0);
	...
	КешНастройкиПодбора.Вставить("ПроцентСкидкиПоДисконтнойКарте", 0);
...
#Область КорзинаЦенаОстатокРезерв
...
#Область СписокСкладскиеОстатки
...
Процедура ДобавитьНоменклатуруВКорзину(СтратегияЗаполненияСтруктурнойЕдиницы = "Общая")
	...
	ДанныеСтрокиКорзины.Вставить("Остаток", ДанныеТекущейСтроки.Остаток);
...
Процедура УстановитьПараметрыДинамическихСписков()
	...
	КурсыВалют = УправлениеНебольшойФирмойСервер.ПолучитьКурсыВалют(Объект.ВалютаВидаЦен, Объект.ВалютаВидаЦен, Объект.Дата);
	...
	СписокЗапасы.Параметры.УстановитьЗначениеПараметра("ИспользоватьНаборы",		ИспользоватьНаборы);
	...
	СписокХарактеристик.Параметры.УстановитьЗначениеПараметра("ИспользоватьНаборы",		ИспользоватьНаборы);
