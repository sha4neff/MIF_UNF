...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Обработки.ПодборПечатьЭтикетокИЦенников.ПроверитьЗаполнениеПараметров(Параметры, Отказ);
	...
	КешНастройкиПодбора.Вставить("СкидкиНаценкиВидны", Ложь);
	...
	КешНастройкиПодбора.Вставить("ДисконтнаяКартаВидна", Ложь);
...
Процедура КорзинаЦенаОстатокРезервХарактеристикаНоменклатураПриИзменении(Элемент)
	...
	// ДисконтныеКарты
	СтруктураДанные.Вставить("ДисконтнаяКарта",	Ложь);
...
Процедура ИзменитьНастройки(Команда)
	...
	ОткрытьФорму("Обработка.ПодборПечатьЭтикетокИЦенников.Форма.Настройка", , ЭтаФорма, Истина, , , ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура РасшифроватьРезерв(Команда)
	...
	ОткрытьФорму("Обработка.ПодборПечатьЭтикетокИЦенников.Форма.РасшифроватьРезерв", ПараметрыРасшифровки, ЭтаФорма, Истина, , ,ОписаниеОповещенияПриЗакрытииПодбора , РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ДобавитьНоменклатуруВКорзину(СтратегияЗаполненияСтруктурнойЕдиницы = "Общая")
	...
	Если КешНастройкиПодбора.ЗапрашиватьКоличество
		...
		ОткрытьФорму("Обработка.ПодборПечатьЭтикетокИЦенников.Форма.КоличествоИЦена", ДанныеСтрокиКорзины, ЭтаФорма, Истина, , ,ОписаниеОповещенияПриЗакрытииПодбора , РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ЗаполнитьСведенияОДокументе(СведенияОДокументе)
	...
	Обработки.ПодборПечатьЭтикетокИЦенников.СтруктураСведенийОДокументе(СведенияОДокументе);
	ЗаполнитьЗначенияСвойств(СведенияОДокументе, Объект);
	СведенияОДокументе.Вставить("СкидкиНаценкиВидны", Ложь);
