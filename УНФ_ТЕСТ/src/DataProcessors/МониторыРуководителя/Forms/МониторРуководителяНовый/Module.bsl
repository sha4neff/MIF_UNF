...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Константы.УчетПоКомпании.Получить() Тогда
		ОтборОрганизация = Справочники.Организации.ОрганизацияКомпания();
...
Процедура ПриОткрытии(Отказ)
	...
	ПодключитьОбработчикОжидания("ЗапуститьФоновоеЗадание", ИнтервалЗапускаФоновогоЗадания, Истина);
...
Процедура УправлениеФормой(Форма)
	...
	Если Форма.ФоновоеЗаданиеЗапущено Тогда
...
// Функция рассчитывает приблизительную высоту элемента формы отображающего табличный документ, по количеству строк
