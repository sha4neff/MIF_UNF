...
Процедура ПослеОбработкиБанковскойВыпискиНаСервере(Результат)
	...
	ИмпортВидыДокументов = КонтекстФормы.ИмпортВидыДокументов;
	ИмпортПризнакОбмена = КонтекстФормы.ИмпортПризнакОбмена;
	ИмпортНеПустые = КонтекстФормы.ИмпортНеПустые;
	...
	ИмпортЗагружаемые = КонтекстФормы.ИмпортЗагружаемые;
