...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ДекорацияСумма.Заголовок = ПодборНоменклатурыВДокументахКлиентСервер.СуммаФорматированнойСтрокой(
		Количество * Цена);
...
Процедура УстановитьДоступность(Параметры)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЕдиницаИзмерения", "Доступность",
		Параметры.ЗапрашиватьЦену);
	...
	Если Не Параметры.ЗапрашиватьКоличество И Параметры.ЗапрашиватьЦену Тогда

		ЭтотОбъект.ТекущийЭлемент = Элементы.Цена;
