...
Процедура ПриОткрытии(Отказ)
	...
	ПодключитьОбработчикОжидания("Подключаемый_ЗапуститьФоновоеЗадание", ИнтервалЗапускаФоновогоЗадания, Истина);
...
Процедура НаполнитьСлучайнымиДанными(ОбъектДиаграмма, ТаблицаЗначений, ОписаниеТочки, ОписаниеСерии)
	...
	ОбъектДиаграмма.ОбластьЗаголовка.Шрифт = Новый Шрифт("Arial", 12, Истина);
...
Процедура ПоказателиПоУмолчанию()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьОтчетность") Тогда
		ОтобразитьПоказатель("Налоги", "ТекущиеПлатежи"); 
		ОтобразитьПоказатель("Налоги", "КоличествоТекущихПлатежей"); 
		ОтобразитьПоказатель("Налоги", "КоличествоТекущихДокументов"); 
	КонецЕсли;
...
Процедура УстановитьВидимостьЭлементовДляМобильногоКлиента()
	...
	Если УправлениеНебольшойФирмойСервер.ЭтоМобильныйКлиент()
		И НЕ УправлениеНебольшойФирмойСервер.ЭтоБольшойЭкранИЛИПланшет() Тогда
		Элементы.ГруппаОбщиеКнопки.Видимость = Ложь;
		Элементы.ГруппаОбщиеКнопкиМобильное.Видимость = Истина;
		Элементы.ДекорацияДобавитьОбъектПеред.Видимость = Ложь;
		Элементы.ДекорацияРазделительПоказатели.Видимость = Ложь;
	ИначеЕсли УправлениеНебольшойФирмойСервер.ЭтоМобильныйКлиент()
		И УправлениеНебольшойФирмойСервер.ЭтоБольшойЭкранИЛИПланшет() Тогда
		Элементы.ГруппаОбщиеКнопки.Видимость = Ложь;
		Элементы.ГруппаОбщиеКнопкиМобильное.Видимость = Истина;
		Элементы.ДекорацияДобавитьОбъектПеред.Видимость = Ложь;
		Элементы.ДекорацияДобавитьОбъектПосле.Видимость = Ложь;
		Элементы.ДекорацияРазделительПоказатели.Видимость = Ложь;
		Элементы.ГруппаПраваяКолонка.Ширина = 24;
	Иначе
		Элементы.ГруппаОбщиеКнопки.Видимость = Истина;
		Элементы.ГруппаОбщиеКнопкиМобильное.Видимость = Ложь;
		Элементы.ДекорацияДобавитьОбъектПеред.Видимость = Истина;
		Элементы.ДекорацияДобавитьОбъектПосле.Видимость = Истина;
		Элементы.ДекорацияРазделительПоказатели.Видимость = Истина;
		Элементы.ГруппаПраваяКолонка.Ширина = 20;
	КонецЕсли;
