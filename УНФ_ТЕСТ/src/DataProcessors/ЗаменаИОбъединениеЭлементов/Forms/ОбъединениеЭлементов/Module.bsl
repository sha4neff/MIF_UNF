...
&НаСервере
Процедура ОбновитьОстаткиПоНоменклатуре();
	
	ОстаткиОбновлены = РегистрыСведений.ОстаткиТоваров.ВыполнитьЗаданиеПоПересчетуОстатковВТехническомРегистре(ОсновнойЭлемент);
