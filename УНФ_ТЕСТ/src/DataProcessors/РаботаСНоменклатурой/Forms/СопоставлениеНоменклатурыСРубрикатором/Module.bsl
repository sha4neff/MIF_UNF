...
Процедура СохранитьСопоставлениеРеквизитов(ТекущаяСтрока, Знач ВидНоменклатуры)
	...
	ИначеЕсли ЗначениеЗаполнено(ФормализованныйРеквизит) Тогда 
		// очистка сопоставления по формализованному реквизиту
		Запрос = Новый Запрос;
		Запрос.Текст = "ВЫБРАТЬ
		...
		Пока Выборка.Следующий() Цикл
			СоответствиеРеквизитов = РегистрыСведений.СоответствиеРеквизитовРаботаСНоменклатурой.СоздатьНаборЗаписей();
			СоответствиеРеквизитов.Отбор.ОбъектСопоставления.Установить(ВидНоменклатуры);
			СоответствиеРеквизитов.Отбор.РеквизитОбъекта.Установить(Выборка.РеквизитОбъекта);
			СоответствиеРеквизитов.Отбор.ИдентификаторРеквизитаКатегории.Установить(Выборка.ИдентификаторРеквизитаКатегории);
			СоответствиеРеквизитов.Записать();
		КонецЦикла;
	Иначе 
		// очистка записей по идентификатору реквизита 1С:Номенклатуры
		СоответствиеРеквизитов = РегистрыСведений.СоответствиеРеквизитовРаботаСНоменклатурой.СоздатьНаборЗаписей();
		СоответствиеРеквизитов.Отбор.ОбъектСопоставления.Установить(ВидНоменклатуры);
