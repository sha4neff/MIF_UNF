...
Функция НомерПоставновления(СчетФактура)
...
Функция РазобратьДокументыНаСчетаФактуры(МассивОбъектов, ЭтоУПД, ЭтоВходящийДокумент = Ложь) Экспорт
	...
	Для каждого ОбъектПечати Из МассивОбъектов Цикл
		...
		Иначе
			...
			СтруктураДанных = УправлениеНебольшойФирмойСервер.ПолучитьПодчиненныйСчетФактуру(ОбъектПечати, ЭтоВходящийДокумент);
		...
		СтрокаОписаниеСФ.ВерсияДокумента 	= НомерПоставновления(СтрокаОписаниеСФ.СчетФактура);
