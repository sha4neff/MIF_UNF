...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПоказатьОписание = ОбщегоНазначения.ХранилищеНастроекДанныхФормЗагрузить("ПроизводствоЗаСмену", "ПоказатьОписаниеПриОткрытии", Истина);
	Если ПоказатьОписание Тогда
		...
		ОбщегоНазначения.ХранилищеНастроекДанныхФормСохранить("ПроизводствоЗаСмену", "ПоказатьОписаниеПриОткрытии", Ложь);
	КонецЕсли; 
...
Процедура ЗаполнитьДеревоЗаказов()
	...
	СхемаКомпоновкиДанных = Обработки.ПроизводствоЗаСмену.ПолучитьМакет("СхемаЗаполнения");
...
Процедура ОбновитьОписание()
	...
	Описание = Обработки.ПроизводствоЗаСмену.ПолучитьМакет("Описание").ПолучитьТекст();
...
Функция ЗаданиеФормированиеДокументовПроизводства()
	...
	"Обработки.ПроизводствоЗаСмену.СформироватьДокументы",
	ПараметрыЗадания,
	ПараметрыВыполнения);
