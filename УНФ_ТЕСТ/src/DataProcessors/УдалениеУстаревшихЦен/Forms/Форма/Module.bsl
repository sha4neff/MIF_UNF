...
Процедура УправлениеСвойствамиЭлементовОтбораВидовЦен()
	...
	Иначе
		...
		ТекстЗаголовока = СтрШаблон(НСтр("ru ='Применимо к %1%2'"), ВидыЦен[0].Значение, ТекстУточнения);
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДекорацияОтборы", "Заголовок", ТекстЗаголовока);
