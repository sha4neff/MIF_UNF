...
Процедура ИзвлечьСведенияОСубъектах(СтрокаТаблицы, СведенияОСубъектах, ПараметрыПечати)
	...
	ОписаниеОтправителя = СведенияОСубъектах.ТаблицаАдресоОтправители.Найти(СтрокаТаблицы.Отправитель, "Объект");
...
Процедура СформироватьКонверт(ОписаниеПечатнойФормы, ДанныеОбъектовПечати, ОбъектыПечати, ПараметрыПечати)
	...
	ТаблицаАдресоОтправители = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъектов(Отправители, , ВидКИОтправителей);
	ТаблицаАдресоОтправители.Индексы.Добавить("Объект");
	
	ВидКИПолучателей = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ПараметрыПечати.ВидАдресаКонтрагента);
	ТаблицаАдресовПолучатели = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъектов(Получатели, , ВидКИПолучателей);
	...
	СведенияОСубъектах.Вставить("ТаблицаАдресоОтправители", ТаблицаАдресоОтправители);
