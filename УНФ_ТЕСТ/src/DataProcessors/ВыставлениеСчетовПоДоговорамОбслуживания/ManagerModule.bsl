...
Процедура ВыполнитьПолучениеДанныхПоДоговорамОбслуживания(Параметры, Результат, Ошибки)
	...
	|	ЕСТЬNULL(ВТДоговорыОбслуживанияАбонЧасть.ДобавлятьПериодВСодержание, ЛОЖЬ) КАК ДобавлятьПериодВСодержание,
	...
	|	ВТВсеОбороты.ДобавлятьПериодВСодержание КАК ДобавлятьПериодВСодержание,
