...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(КонтекстПечати, Параметры.КонтекстПечати, "Организация, Подразделение, СтруктурнаяЕдиница, ПодписьРуководителя, ПодписьЗаведущегоОтделом, ПодписьСтаршегоКассира, ПодписьКассира");
...
Процедура ВосстановитьПодписиПоУмолчанию(Команда)
	...
	ПредыдущиеЗначения = Новый Структура(" ПодписьРуководителя, ПодписьЗаведущегоОтделом, ПодписьСтаршегоКассира, ПодписьКассира");
