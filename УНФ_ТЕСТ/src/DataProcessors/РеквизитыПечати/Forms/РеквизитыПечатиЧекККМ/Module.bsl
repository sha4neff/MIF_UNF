...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(КонтекстПечати, Параметры.КонтекстПечати, "КассаККМ, ПодписьКассира, Контрагент, КонтактноеЛицоПодписант, УсловияГарантийногоТалона");
...
Процедура ВосстановитьПодписиПоУмолчанию(Команда)
	...
	ПредыдущиеЗначения = Новый Структура("ПодписьКассира, КонтактноеЛицоПодписант");
