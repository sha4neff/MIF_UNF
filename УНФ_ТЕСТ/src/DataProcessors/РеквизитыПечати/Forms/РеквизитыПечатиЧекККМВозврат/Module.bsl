...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(КонтекстПечати, Параметры.КонтекстПечати, "Организация, ПодписьРуководителя, ПодписьЗаведущегоОтделом, ПодписьСтаршегоКассира, ПодписьКассира, Контрагент, КонтактноеЛицоПодписант");
...
Процедура ВосстановитьПодписиПоУмолчанию(Команда)
	...
	ПредыдущиеЗначения = Новый Структура("ПодписьРуководителя, ПодписьЗаведущегоОтделом, ПодписьСтаршегоКассира, ПодписьКассира, КонтактноеЛицоПодписант");
...
&НаКлиенте
Процедура КонтекстПечатиПодписьЗаведущегоОтделомПриИзменении(Элемент)
	
	ЗафиксироватьИзменениеЗначенияРеквизита("ПодписьЗаведущегоОтделом");
