	...
	Для каждого ПараметрыЗаказа Из ТаблицаЗаказы Цикл
		...
		Если ПараметрыЗаказа.СпособПополнения = Перечисления.СпособыПополненияЗапасов.Закупка
			...
			Для каждого СтрокаРезультат Из РезультатПоиска Цикл
				...
				Для каждого ДаныеЗаказПокупателя Из СтрокаРезультат.ЗаказыПокупателей Цикл
					КоличествоЗаказ = Мин(ДаныеЗаказПокупателя.Значение, НоваяСтрока.Количество);
					...
					СтруктураПоискаПотребность.Вставить("ЗаказПокупателя", ДаныеЗаказПокупателя.Ключ);
					...
					Если НоваяСтрока.Количество=КоличествоЗаказ Тогда
						НоваяСтрока.ЗаказПокупателя = ДаныеЗаказПокупателя.Ключ;
					Иначе
						...
						СтрокаЗаказ.ЗаказПокупателя = ДаныеЗаказПокупателя.Ключ;
