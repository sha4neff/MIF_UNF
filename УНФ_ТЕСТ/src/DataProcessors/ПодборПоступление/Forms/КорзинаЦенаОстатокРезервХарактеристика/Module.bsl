...
#Область ОбработчикиСобытийЭлементовТаблицыСоставНабора
...
#Область ОбработчикиСобытийЭлементовТаблицыСписокИерархияНоменклатуры
...
#Область ОбработчикиСобытийЭлементовТаблицыСписокИерархияНоменклатурныхГрупп
...
#Область ОбработчикиСобытийЭлементовТаблицыСписокЗапасы
...
#Область ОбработчикиСобытийЭлементовТаблицыСписокСкладскиеОстатки
...
#Область ОбработчикиСобытийЭлементовТаблицыСписокХарактеристик
...
Процедура ДекорацияПерейтиНаНовуюФормуНажатие(Элемент)
	...
	СохранитьУсловиеОтображенияПодсветкиПерехода();
	
	Оповестить("СменитьФормуПобора", Истина, 
	?(Объект.УникальныйИдентификаторФормыВладельца = Новый УникальныйИдентификатор("00000000-0000-0000-0000-000000000000"), Неопределено, Объект.УникальныйИдентификаторФормыВладельца));
...
&НаСервере
Процедура СохранитьУсловиеОтображенияПодсветкиПерехода()
