...
Процедура ПодготовитьОбластьИзВыгрузки(Знач КодОбластиДанных, Знач ИдентификаторВыгрузки, 
	...
	Попытка
		...
		РазмерФайла = РаботаВМоделиСервиса.ПолучитьРазмерФайлаИзХранилищаМенеджераСервиса(ИдентификаторВыгрузки);
		Если РазмерФайла = Неопределено Или РазмерФайла <= 1024 * 1024 * 1024 Тогда
			...
			РезультатЗагрузки = МодульВыгрузкаЗагрузкаОбластейДанных.ЗагрузитьТекущуюОбластьИзАрхива(
				ИмяФайлаВыгрузки,,,
		...
		Иначе
			...
			Архив = РаботаВМоделиСервиса.ПрочитатьАрхив(ИдентификаторВыгрузки);
