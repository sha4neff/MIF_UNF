...
Процедура ПередЗаписьюОтчетаЭквайера(Объект) Экспорт
	...
	Если ПараметрыЭквайринга.КонтрольВзаиморасчетовЭквайринг Тогда
		...
		// Приведем в соответствие суммы оплат и суммы комисси в шапке и в ТЧ
		Если ПараметрыЭквайринга.РасчетКомиссиВОтчетеЭквайера И Объект.ЭквайринговыеОперации.Количество() > 0 Тогда
...
Функция ПолучитьПараметрыЭквайрингаДляДокумента(Документ) Экспорт
	...
	ПараметрыЭквайринга.Вставить("РасчетКомиссиВОтчетеЭквайера", 	ЭквайринговыйТерминал.Договор.РасчетКомиссиВОтчетеЭквайера);
