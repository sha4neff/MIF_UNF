...
Процедура СинхронизацияПередЗаписьюКартинки(Источник, Отказ) Экспорт
	...
	Иначе
		...
		Если Источник.Картинка.Получить() <> ТекущаяКартинка И Источник.НомерКартинки = Источник.Ссылка.НомерКартинки И Источник.НомерКартинки = Источник.Ссылка.НомерКартинки И Источник.Ссылка.НужноПолучитьКартинкуССервера <> Истина Тогда
