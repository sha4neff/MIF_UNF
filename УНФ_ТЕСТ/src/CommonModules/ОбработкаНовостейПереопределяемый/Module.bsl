...
//
// Параметры:
//  Форма                                    - ФормаКлиентскогоПриложения - форма, в которой был включен механизм
...
//                                             события "ПриОткрытии". Если передано какое-то значение, то будет
//                                             подсчитано количество очень важных контекстных новостей. И если это
//                                             количество > 0, то открывающая форма инициирует открытие формы просмотра
//                                             таких новостей;
...
//  МассивСтруктурНовостей                   - Массив из Структура - Массив структур контекстных новостей для этой формы
//   с ключами:
//   * НомерСтрокиНовости      - Число;
//   * ЛентаНовостей           - СправочникСсылка.ЛентаНовостей;
//   * Новость                 - СправочникСсылка.Новости;
...
//  ТаблицаНовостейДляПанелиКонтекстныхНовостей - ТаблицаЗначений - незаполненная таблица новостей для панели
//                           контекстных новостей. Список колонок см. ОбработкаНовостей.КонтекстныеНовости_ПриСозданииНаСервере;
	...
	Если ВРег(КодКатегорииНовостей) = ВРег("FnOptionDataAreaOff") Тогда
		...
		Если ЗначениеКатегорииНовостей = "ЭтоНоваяБаза" Тогда
			...
			Если ВерсияНачалаРаботыСПрограммой <> Неопределено Тогда
				ЭтоНоваяБаза = (
					ОбщегоНазначенияКлиентСервер.СравнитьВерсииБезНомераСборки(
...
//
// Параметры:
//  ОченьВажныеНовости - Массив из Структура - массив структур, в который будут возвращены новости с важностью "Очень
//    важная", где:
...
//  ВажныеНовости      - Массив из Структура - массив структур, в который будут возвращены новости с важностью "Важная",
//    где:
//    * Новость                        - СправочникСсылка.Новости - ссылка на новость;
//    * НовостьУникальныйИдентификатор - УникальныйИдентификатор - УИН от ссылки на новость;
