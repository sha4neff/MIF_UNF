...
Процедура ОбработкаЗаполненияИмяКассира(ИмяКассира, СтандартнаяОбработка) Экспорт
	...
	РеквизитыКассира = РозничныеПродажиСервер.ПолучитьРеквизитыКассира(Неопределено);
	ИмяКассира = РеквизитыКассира.ИмяКассира;
	СтандартнаяОбработка = Не ЗначениеЗаполнено(ИмяКассира);
...
Процедура ОбработкаЗаполненияИННКассира(ИННКассира, СтандартнаяОбработка) Экспорт
	...
	РеквизитыКассира = РозничныеПродажиСервер.ПолучитьРеквизитыКассира(Неопределено);
	ИННКассира = РеквизитыКассира.КассирИНН;
