...
Процедура ОбновитьДанныеГосударственногоОргана(Реквизиты) Экспорт
	...
	// В противном случае создаем новый расчетный счет, предварительно убедившись, что такого расчетного счета у
	// контрагента уже нет.
...
Процедура ОбработатьОшибкуСервиса(ОписаниеОшибки, СтруктураРеквизитов)
	...
	КодОсновногоЯзыка = ОбщегоНазначения.КодОсновногоЯзыка(); // Для записи события в журнал регистраации
