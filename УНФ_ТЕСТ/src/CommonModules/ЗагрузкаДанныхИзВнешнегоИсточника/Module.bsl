...
Процедура ПриСозданииНаСервере(ОбъектЗаполнения, НастройкиЗагрузкиДанных, ЭтотОбъект, ИспользоватьФормуБСП = Истина) Экспорт
	...
	НастройкиЗагрузкиДанных.Вставить("ИспользоватьСовместно", ИспользоватьСовместноСПоставляемойЧастьюБСП() И ИспользоватьФормуБСП И НЕ ОбщегоНазначенияКлиентСервер.ЭтоВебКлиент() И НЕ УправлениеНебольшойФирмойСервер.ЭтоМобильныйКлиент());
	
	Если ОбщегоНазначенияКлиентСервер.ЭтоВебКлиент()
		ИЛИ УправлениеНебольшойФирмойСервер.ЭтоМобильныйКлиент()
