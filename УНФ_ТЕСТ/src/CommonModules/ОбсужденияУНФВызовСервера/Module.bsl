...
// Вызывает процедуру формирования массива структур, содержащий имена и описания пользователей для использования в
// тексте обсуждений.
// 
// Параметры: Нет
//
...
Функция СловарьОписанийПользователей() Экспорт
	...
	Возврат ОбсужденияУНФ.СловарьОписанийПользователей();
...
Функция ДобавитьСообщение(Комментарий, Ссылка, Системный = Ложь) Экспорт
	...
	ОбсужденияУНФ.ДобавитьСообщение(Комментарий, Ссылка, ,Системный);
...
Функция ОбсужденияПоОбъекту(Ссылка, ЗаПериод=Ложь) Экспорт
	...
	Возврат ОбсужденияУНФ.ОбсужденияПоОбъекту(Ссылка, ЗаПериод);
...
Функция ПолучитьМассивСтруктурИзТаблицы(ТаблицаЗначений)
...
Процедура ВключитьФОИспользоватьНапоминанияПользователяПриОбновлении(СтруктураПараметров) Экспорт
	...
	ОбсужденияУНФ.ВключитьФОИспользоватьНапоминанияПользователяПриОбновлении(СтруктураПараметров);
...
Функция ПолучитьДанныеФайлаСправочникаПоНавигационнойСсылке(СтрокаНавигационнойСсылкиСправочника) Экспорт
	...
	Возврат ОбсужденияУНФ.ПолучитьДанныеФайлаСправочникаПоНавигационнойСсылке(СтрокаНавигационнойСсылкиСправочника);
