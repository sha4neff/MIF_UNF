...
//
Функция ВыполнитьПроверку(СтруктураПараметровПроверкиДанных, ОкноДляРезультатов = Неопределено, ОграниченияПроверки = Неопределено, СохранятьПротокол = Истина) Экспорт
...
Функция ВыполнитьПроверкуДанныхДляСправки2НФДЛ(Дата, Организация, Сотрудник) Экспорт
	...
	РезультатПроверки = ВыполнитьПроверку(СтруктураПараметровПроверкиДанных,,ОграниченияПроверки);
