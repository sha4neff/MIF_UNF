...
Функция СформироватьПутьНаСервере(ПараметрыСобытия) Экспорт
	...
	ПутьНаСервере = СтрЗаменить(ПутьНаСервере, "%ШиринаЭкрана%", Строка(Формат(ПараметрыСеанса.ШиринаЭкрана, "ЧДЦ=; ЧГ=0")));
	ПутьНаСервере = СтрЗаменить(ПутьНаСервере, "%ВысотаЭкрана%", Строка(Формат(ПараметрыСеанса.ВысотаЭкрана, "ЧДЦ=; ЧГ=0")));
	...
	ПутьНаСервере = СтрЗаменить(ПутьНаСервере, "%z%", Строка(Формат(Гсч.СлучайноеЧисло(0, 999999), "ЧДЦ=; ЧГ=0")));
