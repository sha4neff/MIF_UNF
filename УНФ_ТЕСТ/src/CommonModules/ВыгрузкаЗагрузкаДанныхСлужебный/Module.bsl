...
//
// Параметры:
//	ДанныеФайла - Строка, УникальныйИдентификатор - имя файла архива или его идентификатор
//	ПараметрыЗагрузки - Структура - параметры загрузки, см. параметр "ПараметрыЗагрузки" процедуры "ЗагрузитьТекущуюОбластьИзАрхива" общего модуля "ВыгрузкаЗагрузкаОбластейДанных".
//
// Возвращаемое значение:		
//  Структура - с полями:
...
Функция ЗагрузитьДанныеТекущейОбластиИзАрхива(Знач ДанныеФайла, Знач ПараметрыЗагрузки) Экспорт
	...
	Если ПараметрыЗагрузки.Свойство("ДанныеРасширений")
		И ПараметрыЗагрузки.ДанныеРасширений.Свойство("РасширенияДляВосстановления", РасширенияДляВосстановления) Тогда
...
Функция НачатьЗагрузкуДанныхТекущейОбластиИзАрхива(Знач ДанныеФайла, Знач ПараметрыЗагрузки, 
	...
	ПослеЗагрузкиДанныхИнформационнойБазы(ПараметрыЗагрузки, Контейнер, Обработчики, ПотокЗаменыСсылок);
...
Процедура ПослеЗагрузкиДанныхИнформационнойБазы(ПараметрыЗагрузки,
