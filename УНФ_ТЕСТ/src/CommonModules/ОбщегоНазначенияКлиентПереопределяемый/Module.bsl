...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	Иначе
		...
		Если ПараметрыРаботыКлиента.ДоступноИспользованиеРазделенныхДанных Тогда
			...
			// БиблиотекаМобильноеПриложение
			МобильноеПриложение20КлиентПереопределяемый.ПриНачалеРаботыСистемы(Параметры);
			// Конец БиблиотекаМобильноеПриложение
...
Процедура ПослеНачалаРаботыСистемы() Экспорт
	...
	Если ПараметрыРаботыКлиента.ДоступноИспользованиеРазделенныхДанных Тогда
		...
		Если НЕ ПараметрыРаботыКлиента.ПоказатьОкноНачалоРаботыСПрограммой Тогда
			...
			#Если НЕ ТолстыйКлиентОбычноеПриложение Тогда
				...
				ОбсужденияУНФКлиент.ПослеЗапускаСистемы();
	...
	// СборСтатистики
	УправлениеНебольшойФирмойКлиент.ОтправитьИнформациюОЗапускеПриложения();
	// Конец СборСтатистики
