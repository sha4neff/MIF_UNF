...
// Функция возвращает структуру с аналтикой по Подразделению и проекту переданного документа
//
// Параметры:
...
//   ЗначениеПеречисления - ПеречислениеСсылка - Значение перечесления с видом операции
