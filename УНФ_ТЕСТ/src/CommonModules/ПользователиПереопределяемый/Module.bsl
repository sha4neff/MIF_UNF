...
Процедура СвязатьПользователяССотрудником(Пользователь) Экспорт
	...
	СвязанныеПользователи = РегистрыСведений.СотрудникиПользователя.ПолучитьСотрудниковПользователя(Пользователь, Истина);
...
Процедура НастройкиПрайсЛистов(Пользователь)
...
Процедура ПриЗаписиПользователя(Источник, Отказ) Экспорт
	...
	НастройкиПрайсЛистов(Пользователь);
