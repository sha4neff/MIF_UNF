...
Процедура ДобавитьПльзователяВПриложение(ДанныеАвторизации, НомерОбласти, ЛогинПользователя, ПравоПользователя) Экспорт
...
Функция ПараметрыОтправкиИнтерфейсМенеджераСервиса(Метод, ДанныеАвторизации)
	...
	//Тело = Новый Структура;
	//ДобавитьВТелоНазваниеМетода(Тело, Метод);
	////ДобавитьВТелоПараметрАвторизация(Тело, ДанныеАвторизации.КодАбонента);
