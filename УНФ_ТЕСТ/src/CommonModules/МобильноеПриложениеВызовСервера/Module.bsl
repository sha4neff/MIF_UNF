...
Функция ЕстьОграничениеМобильногоУНФ20() Экспорт
	...
	Если РаботаВМоделиСервиса.РазделениеВключено()
		...
		Возврат Тарификация.ЗарегистрированаЛицензияБезлимитнойУслуги(ИдентификаторПоставщикаУслугМобильногоПриложения(), ИдентификаторУслугиОграниенияМобильногоПриложения20());
	Иначе
		Возврат Ложь;
	КонецЕсли;
...
Функция ЕстьОграничениеМобильногоУНФ() Экспорт
	...
	Если РаботаВМоделиСервиса.РазделениеВключено()
		И ИспользоватьКонтрольТарификации() Тогда
		Возврат Тарификация.ЗарегистрированаЛицензияБезлимитнойУслуги(ИдентификаторПоставщикаУслугМобильногоПриложения(), ИдентификаторУслугиОграниенияМобильногоПриложения());
	Иначе
		Возврат Ложь;
	КонецЕсли;
...
Процедура ПриФормированииСпискаУслуг(ПоставщикиУслуг) Экспорт
	...
	Услуга.Вставить("Идентификатор", ИдентификаторУслугиОграниенияМобильногоПриложения20());
	...
	Услуга = Новый Структура;
	Услуга.Вставить("Идентификатор", ИдентификаторУслугиОграниенияМобильногоПриложения());
...
Функция ИдентификаторУслугиОграниенияМобильногоПриложения20() Экспорт
	
	Возврат "ОграниениеМПУНФ20";
	
КонецФункции

Функция ИдентификаторУслугиОграниенияМобильногоПриложения() Экспорт
