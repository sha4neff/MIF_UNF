...
Процедура НастройкиПрайсЛистовПриСозданииНовогоПользователя(Пользователь, ОбновитьЗначениеНастройки = Ложь) Экспорт
	...
	Если (ЗначениеЗаполнено(ВыводитьВопросПоОрганизации)
		...
		УправлениеНебольшойФирмойСервер.УстановитьНастройкуПользователя(Истина, "ВыводитьВопросСозданииПервогоПрайсЛистаОрганизации", Пользователь);
	...
	Если (ЗначениеЗаполнено(ВыводитьВопросПоКонтрагентам)
		...
		УправлениеНебольшойФирмойСервер.УстановитьНастройкуПользователя(Истина, "ВыводитьВопросСозданииПервогоПрайсЛистаКонтрагента", Пользователь);
