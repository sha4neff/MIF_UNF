...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// УНФ
	УправлениеДоступомУНФ.ПриЗаполненииПоставляемыхПрофилейГруппДоступа_Продажи(ОписанияПрофилей);
	УправлениеДоступомУНФ.ПриЗаполненииПоставляемыхПрофилейГруппДоступа_Закупки(ОписанияПрофилей);
	УправлениеДоступомУНФ.ПриЗаполненииПоставляемыхПрофилейГруппДоступа_Производство(ОписанияПрофилей);
	УправлениеДоступомУНФ.ПриЗаполненииПоставляемыхПрофилейГруппДоступа_Деньги(ОписанияПрофилей);
	УправлениеДоступомУНФ.ПриЗаполненииПоставляемыхПрофилейГруппДоступа_Зарплата(ОписанияПрофилей);
	УправлениеДоступомУНФ.ПриЗаполненииПоставляемыхПрофилейГруппДоступа_РабочееМестоКассира(ОписанияПрофилей);
	УправлениеДоступомУНФ.ПриЗаполненииПоставляемыхПрофилейГруппДоступа_Налоги(ОписанияПрофилей);
	УправлениеДоступомУНФ.ПриЗаполненииПоставляемыхПрофилейГруппДоступа_ТолькоПросмотр(ОписанияПрофилей);
	УправлениеДоступомУНФ.ПриЗаполненииПоставляемыхПрофилейГруппДоступа_ВетеринарныйВрач(ОписанияПрофилей);
	// Конец УНФ
	
	КП_ОбщееСервер.ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей); //kp-unf.ru
