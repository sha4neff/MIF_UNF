...
//
Процедура РассчитатьСуммуВСтрокеТабличнойЧастиЗапасыОтчетКомиссионера(Объект, ИспользоватьСерийныеНомераОстатки, СтрокаТабличнойЧасти, РасчитыватьСуммуПередачи = Ложь) Экспорт
	
	СтрокаТабличнойЧасти.Сумма = СтрокаТабличнойЧасти.Количество * СтрокаТабличнойЧасти.Цена;
	
	Если РасчитыватьСуммуПередачи Тогда
