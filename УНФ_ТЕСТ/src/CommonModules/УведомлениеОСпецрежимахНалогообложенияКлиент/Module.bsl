...
Процедура ВыбратьОбъект1СОтчетности(ВыполняемоеОповещение, Форма, Раздел) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"СоздатьНаОснованииТребования_ПослеВыбора", 
		ЭтотОбъект,
...
Процедура СоздатьНаОснованииТребования_ПослеВыбора(ВыбранныйОбъект, ВходящийКонтекст) Экспорт 
	
	ЭтоНужноеТребование = Ложь;
	Если ЗначениеЗаполнено(ВыбранныйОбъект) Тогда 
		Если ТипЗнч(ВыбранныйОбъект) = Тип("СправочникСсылка.ДокументыРеализацииПолномочийНалоговыхОрганов") Тогда
	...
	Если ЭтоНужноеТребование Тогда
	...
	Иначе
		...
		ОписаниеОповещения = Новый ОписаниеОповещения(
			"СоздатьНаОснованииТребованияЗавершение_ПослеПредупреждения", 
			ЭтотОбъект, 
			ВходящийКонтекст);
...
Процедура СоздатьНаОснованииТребованияЗавершение_ПослеПредупреждения(ВходящийКонтекст) Экспорт 
