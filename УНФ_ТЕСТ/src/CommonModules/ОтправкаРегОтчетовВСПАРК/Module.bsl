...
Функция ЭтоНужныйВидОтчетаСПАРК(СсылкаНаОтчет) Экспорт
	...
	ЭтоОтчет = ТипЗнч(СсылкаНаОтчет) = Тип("ДокументСсылка.РегламентированныйОтчет") И 
		(СсылкаНаОтчет.ИсточникОтчета = "РегламентированныйОтчетБухОтчетность"
		ИЛИ СсылкаНаОтчет.ИсточникОтчета = "РегламентированныйОтчетБухОтчетностьМП");
		
	ЭтоЭлПредставление = ТипЗнч(СсылкаНаОтчет) = Тип("СправочникСсылка.ЭлектронныеПредставленияРегламентированныхОтчетов") И 
		(СсылкаНаОтчет.ВидОтчета.Источник = "РегламентированныйОтчетБухОтчетность" 
		ИЛИ СсылкаНаОтчет.ВидОтчета.Источник = "РегламентированныйОтчетБухОтчетностьМП");
