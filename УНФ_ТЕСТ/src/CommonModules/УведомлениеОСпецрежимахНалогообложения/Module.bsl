...
Функция ФайлыТребования(ОтветНаТребованиеДокументов) Экспорт
	
	УстановитьПривилегированныйРежим(Истина);
	
	ИменаФайловВложений = Новый Массив;
	ИмяФайлаОписи       = "";
	
	Результат = Новый Структура();
	Результат.Вставить("ИменаФайловВложений", ИменаФайловВложений);
	Результат.Вставить("ИмяФайлаОписи",       ИмяФайлаОписи);
	...
	СообщенияЦикла    = КонтекстЭДОСервер.ПолучитьСообщенияЦиклаОбмена(ЦиклОбмена,,,Истина);
	...
	Вложения = КонтекстЭДОСервер.ПолучитьВложенияТранспортногоСообщения(ТранспортноеСообщение);
